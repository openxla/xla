...
This branch (`nv-staging/2026-05-01`) consolidates unmerged PRs for NVIDIA large-scale training work while upstream review is pending.
...
- **Branch:** `nv-staging/2026-05-01`
- **Rolling alias:** `nv-staging/latest` (always points to the most recent snapshot)
- **JAX commit:** [2db21711c](https://github.com/jax-ml/jax/commit/2db21711c)
...
cd xla
git checkout nv-staging/2026-05-01   # this specific snapshot
# or
...
git checkout 2db21711c

git clone git@github.com:openxla/xla.git
cd xla && git checkout nv-staging/2026-05-01 && cd ..
```
