...
This branch (`nv-staging/2026-05-15`) consolidates unmerged PRs for NVIDIA large-scale training work while upstream review is pending.
...
- **Branch:** `nv-staging/2026-05-15`
- **Rolling alias:** `nv-staging/latest` (always points to the most recent snapshot)
- **JAX commit:** [c5d9cb605](https://github.com/jax-ml/jax/commit/c5d9cb605)
...
cd xla
git checkout nv-staging/2026-05-15   # this specific snapshot
# or
...
git checkout c5d9cb605

git clone git@github.com:openxla/xla.git
cd xla && git checkout nv-staging/2026-05-15 && cd ..
```
