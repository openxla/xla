...
load("@tsl//third_party/absl:workspace.bzl", absl = "repo")
load("@tsl//third_party/benchmark:workspace.bzl", benchmark = "repo")
load("@tsl//third_party/clang_toolchain:cc_configure_clang.bzl", "cc_download_clang_toolchain")
load("@tsl//third_party/ducc:workspace.bzl", ducc = "repo")
load("@tsl//third_party/eigen3:workspace.bzl", eigen3 = "repo")
load("@tsl//third_party/farmhash:workspace.bzl", farmhash = "repo")
load("@tsl//third_party/gemmlowp:workspace.bzl", gemmlowp = "repo")
load("@tsl//third_party/git:git_configure.bzl", "git_configure")
...
load("@tsl//third_party/systemlibs:syslibs_configure.bzl", "syslibs_configure")
load("@tsl//third_party/tensorrt:tensorrt_configure.bzl", "tensorrt_configure")
load("@tsl//third_party/tensorrt:workspace.bzl", tensorrt = "repo")
...
def _tf_repositories():
    ...
    tf_http_archive(
        ...
        build_file = "@tsl//third_party/mkl_dnn:mkldnn_acl.BUILD",
        patch_file = [
            "@tsl//third_party/mkl_dnn:onednn_acl_threadcap.patch",
            "@tsl//third_party/mkl_dnn:onednn_acl_reorder.patch",
            "@tsl//third_party/mkl_dnn:onednn_acl_thread_local_scheduler.patch",
            "@tsl//third_party/mkl_dnn:onednn_acl_fp32_bf16_reorder.patch",
            "@tsl//third_party/mkl_dnn:onednn_acl_bf16_capability_detection_for_ubuntu20.04.patch",
            "@tsl//third_party/mkl_dnn:onednn_acl_indirect_conv.patch",
            "@tsl//third_party/mkl_dnn:onednn_acl_allow_blocked_weight_format_for_matmul_primitive.patch",
            "@tsl//third_party/mkl_dnn:onednn_acl_fix_segfault_during_postop_execute.patch",
            "@tsl//third_party/mkl_dnn:onednn_acl_add_bf16_platform_support_check.patch",
            "@tsl//third_party/mkl_dnn:onednn_acl_add_sbgemm_matmul_primitive_definition.patch",
        ],
    ...
    tf_http_archive(
        ...
        patch_file = [
            "@tsl//third_party/compute_library:compute_library.patch",
            "@tsl//third_party/compute_library:acl_thread_local_scheduler.patch",
            "@tsl//third_party/compute_library:exclude_omp_scheduler.patch",
            "@tsl//third_party/compute_library:include_string.patch",
        ],
	...
	sha256 = "b13bfd1587022f04830488257f6faa75c933ee1824273451d33f8d4dad00870e",
	strip_prefix = "googletest-72189081cae8b729422860b195bf2cad625b7eb4",
	urls = tf_mirror_urls("https://github.com/google/googletest/archive/72189081cae8b729422860b195bf2cad625b7eb4.zip"),
    )
    ...
    tf_http_archive(
        ...
        system_build_file = "@tsl//third_party/systemlibs:cython.BUILD",
    ...
    tf_http_archive(
        ...
        patch_file = ["@tsl//third_party/grpc:upb_platform_fix.patch"],
    ...
    tf_http_archive(
        ...
        build_file = "@tsl//third_party/spirv_llvm_translator:spirv_llvm_translator.BUILD",
        patch_file = ["@tsl//third_party/spirv_llvm_translator:spirv_llvm_translator.patch"],
