...
load("//third_party/bazel_rules/rules_cc/cc/common:cc_common.bzl", "cc_common")  # copybara:strip
load("//third_party/bazel_rules/rules_cc/cc/common:cc_info.bzl", "CcInfo")  # copybara:strip
