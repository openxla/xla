...
def _python_repository_impl(ctx):
    ...
    remove_wheel_hash = ctx.attr.remove_wheel_hash
...
python_repository = repository_rule(
    ...
    attrs = {
        ...
        # These helps bypass strict rules by removing hash from requirement
        # lines of each packages
        "remove_wheel_hash": attr.bool(
            mandatory = False,
            default = False,
        ),
    },
