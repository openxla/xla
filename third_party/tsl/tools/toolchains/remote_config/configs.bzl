...
def initialize_rbe_configs():
    ...
    sigbuild_tf_configs(
        name_container_map = {
            "sigbuild-r2.14-clang": "docker://gcr.io/tensorflow-sigs/build:544497398-python3.9",
            "sigbuild-r2.14-clang-python3.8": "docker://gcr.io/tensorflow-sigs/build:544497398-python3.8",
            "sigbuild-r2.14-clang-python3.9": "docker://gcr.io/tensorflow-sigs/build:544497398-python3.9",
            "sigbuild-r2.14-clang-python3.10": "docker://gcr.io/tensorflow-sigs/build:544497398-python3.10",
            "sigbuild-r2.14-clang-python3.11": "docker://gcr.io/tensorflow-sigs/build:544497398-python3.11",
        },
        # Unclear why LIBC is set to 2.19 here, and yet manylinux2010 is 2.12
        # and manylinux2014 is 2.17.
        env = {
