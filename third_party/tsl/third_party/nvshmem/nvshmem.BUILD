...
cuda_library(
    ...
    local_defines = [
        "__CUDACC_RDC__",  # TODO(patrios): Ask NVIDIA about this
    ],
    deps = [
        ":nvshmem_hdrs",
        "@local_config_cuda//cuda:cuda_headers",
...
cuda_library(
    ...
    srcs = [
        ...
        "src/host/stream/coll/alltoall/alltoall.cu",
        "src/host/stream/coll/barrier/barrier.cu",
        "src/host/stream/coll/broadcast/broadcast.cu",
        "src/host/stream/coll/fcollect/fcollect.cu",
        ...
        "src/host/stream/comm/cuda_interface_sync.cu",
...
cuda_library(
    ...
    srcs = [
        ...
        "src/host/team/team.cu",
        "src/host/team/team_internal.cpp",
        "src/host/team/team_internal_cuda.cu",
...
options_substitions = {
    ...
    "#cmakedefine NVSHMEM_ENABLE_ALL_DEVICE_INLINING": "#define NVSHMEM_ENABLE_ALL_DEVICE_INLINING",  # "/* #undef NVSHMEM_ENABLE_ALL_DEVICE_INLINING */", # TODO(patrios): Ask NVIDIA about this
}
