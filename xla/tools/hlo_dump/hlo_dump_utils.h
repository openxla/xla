...
inline constexpr double kNoScoreDiffScore = -1.0;
inline constexpr double kConstantNanInfDiffScore = -2.0;
inline constexpr double kRuntimeNanInfMismatchDiffScore = -3.0;
