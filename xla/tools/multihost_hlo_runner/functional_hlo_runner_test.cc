...
TEST_F(FunctionalHloRunnerTest, SingleDevicePinnedHostZeroInputs) {
  ...
  TF_ASSERT_OK_AND_ASSIGN(auto hlo_module_and_arguments,
  ...
  TF_ASSERT_OK_AND_ASSIGN(
      auto output, FunctionalHloRunner::CompileAndRun(*client, debug_options,
          preproc_options, compile_options, running_options, 
            hlo_module.get(), arguments));
