...
class MutableLiteralBase : public LiteralBase {
 public:
  ...
  // Type alias for static type checking Populate generator type.
  ...
  // Type alias for static type checking PopulateParallel generator type.
  template <typename NativeT, typename Generator>
  ...
  // Type alias for static type checking PopulateLinear generator type.
  template <typename NativeT, typename Generator>
  using IsLinearGenerator = std::enable_if_t<
      std::is_convertible_v<NativeT, std::invoke_result_t<Generator, int64_t>>>;

  // Type alias for static type checking PopulateLinearParallel generator type.
  template <typename NativeT, typename Generator>
...
TF_ATTRIBUTE_NOINLINE absl::Status MutableLiteralBase::PopulateInternal(
    Generator&& generator, bool parallel) {
