...
DebugOptions DefaultDebugOptionsIgnoringFlags() {
  ...
  opts.set_xla_gpu_allow_small_all_reduce_kernel(false);
...
void MakeDebugOptionsFlags(std::vector<tsl::Flag>* flag_list,
  ...
  flag_list->push_back(tsl::Flag(
      "xla_gpu_allow_small_all_reduce_kernel",
      bool_setter_for(&DebugOptions::set_xla_gpu_allow_small_all_reduce_kernel),
      debug_options->xla_gpu_allow_small_all_reduce_kernel(),
