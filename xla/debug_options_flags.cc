...
DebugOptions DefaultDebugOptionsIgnoringFlags() {
  ...
  opts.set_xla_gpu_unsafe_pipelined_while_loop_annotator_rotate_right_pattern(
      false);
...
void MakeDebugOptionsFlags(std::vector<tsl::Flag>* flag_list,
  ...
  flag_list->push_back(tsl::Flag(
      ...
      "this flag to false."));
  flag_list->push_back(tsl::Flag(
      "xla_gpu_unsafe_pipelined_while_loop_annotator_rotate_right_pattern",
      bool_setter_for(
          &DebugOptions::
              set_xla_gpu_unsafe_pipelined_while_loop_annotator_rotate_right_pattern),
      debug_options
          ->xla_gpu_unsafe_pipelined_while_loop_annotator_rotate_right_pattern(),
