...
DebugOptions DefaultDebugOptionsIgnoringFlags() {
  ...
  opts.set_xla_cpu_collective_call_warn_stuck_timeout_seconds(20);
...
void MakeDebugOptionsFlags(std::vector<tsl::Flag>* flag_list,
  ...
  flag_list->push_back(tsl::Flag(
      ...
      int32_setter_for(
          &DebugOptions::
              set_xla_cpu_collective_call_warn_stuck_timeout_seconds),
      debug_options->xla_cpu_collective_call_warn_stuck_timeout_seconds(),
      "Set timeout for Collective Call Rendezvous stuck warning"));
  flag_list->push_back(tsl::Flag(
      "xla_cpu_collective_call_terminate_timeout_seconds",
      int32_setter_for(
          &DebugOptions::
              set_xla_cpu_collective_call_terminate_timeout_seconds),
