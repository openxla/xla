...
DebugOptions DefaultDebugOptionsIgnoringFlags() {
  ...
  opts.set_xla_gpu_experimental_debug_buffer_saver_directory("");
...
void MakeDebugOptionsFlags(std::vector<tsl::Flag>* flag_list,
  ...
  flag_list->push_back(tsl::Flag(
      ...
      "inputs/outputs."));
  flag_list->push_back(tsl::Flag(
      "xla_gpu_experimental_debug_buffer_saver_directory",
      string_setter_for(
          &DebugOptions::set_xla_gpu_experimental_debug_buffer_saver_directory),
      debug_options->xla_gpu_experimental_debug_buffer_saver_directory(),
