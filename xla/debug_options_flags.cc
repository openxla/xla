...
DebugOptions DefaultDebugOptionsIgnoringFlags() {
  ...
  opts.set_xla_gpu_enable_nccl_symmetric_buffers(false);
...
void MakeDebugOptionsFlags(std::vector<tsl::Flag>* flag_list,
  ...
  flag_list->push_back(tsl::Flag(
      ...
      bool_setter_for(&DebugOptions::set_xla_gpu_enable_nccl_symmetric_buffers),
      debug_options->xla_gpu_enable_nccl_symmetric_buffers(),
