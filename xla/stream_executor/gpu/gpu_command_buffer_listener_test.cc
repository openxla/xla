...
class MockGpuCommandBufferListener : public GpuCommandBufferListener {
 public:
  MOCK_METHOD(void, OnRegisterNodeAnnotation,
              (GpuGraphHandle graph, GpuCommandBuffer::GraphNodeHandle node,
               absl::string_view annotation),
              (override));
  MOCK_METHOD(void, OnRegisterGraphSize, (GpuGraphHandle graph, size_t size),
              (override));
  MOCK_METHOD(void, OnRegisterChildGraph,
              (GpuGraphHandle parent_graph, GpuGraphHandle child_graph,
               ...
               bool is_conditional),
              (override));
  MOCK_METHOD(void, OnRegisterGraphExec,
              (GpuGraphExecHandle graph_exec, GpuGraphHandle graph),
              (override));
  MOCK_METHOD(void, OnUnregisterGraphExec, (GpuGraphExecHandle graph_exec),
              (override));
  MOCK_METHOD(void, OnUnregisterGraphAnnotations, (GpuGraphHandle graph),
              (override));
};
