...
// CUDA driver API) / HSACO modules (can be loaded with ROCM driver api), and some
// of the kernels are written directly in CUDA C++ and can be loaded from a symbol
// pointer (to test StreamExecutor CUDA runtime integration).
