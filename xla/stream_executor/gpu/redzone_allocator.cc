...
tsl::StatusOr<DeviceMemory<uint8_t>> RedzoneAllocator::AllocateBytes(
  ...
  TF_ASSIGN_OR_RETURN(DeviceMemory<uint8_t> lhs_redzone,
                      DeviceMemory<uint8_t>::GetSlice<uint8_t>(
                          allocated_buffer_memory, 0, redzone_size_));

  TF_ASSIGN_OR_RETURN(DeviceMemory<uint8_t> data_chunk,
                      DeviceMemory<uint8_t>::GetSlice<uint8_t>(
  ...
  TF_ASSIGN_OR_RETURN(DeviceMemory<uint8_t> rhs_redzone_nonslop,
                      DeviceMemory<uint8_t>::GetSlice<uint8_t>(
                          allocated_buffer_memory,
...
static tsl::StatusOr<RedzoneCheckStatus> CheckRedzonesForBuffer(
  ...
  TF_ASSIGN_OR_RETURN(
      ...
      DeviceMemory<uint8_t>::GetSlice<uint8_t>(buffer_uint8, 0,
                                               /*element_count=*/redzone_size));
  TF_ASSIGN_OR_RETURN(DeviceMemory<uint8_t> user_allocation,
                      DeviceMemory<uint8_t>::GetSlice<uint8_t>(
                          buffer_uint8, redzone_size,
                          /*element_count=*/user_allocation_size));
  TF_ASSIGN_OR_RETURN(DeviceMemory<uint8_t> rhs_redzone,
                      DeviceMemory<uint8_t>::GetSlice<uint8_t>(
                          buffer_uint8, redzone_size + user_allocation_size,
