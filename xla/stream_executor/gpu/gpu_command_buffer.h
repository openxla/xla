...
class GpuCommandBuffer : public CommandBuffer {
 ...
 protected:
  ...
  GraphNodeHandles graph_tail_nodes() const {
 ...
 protected:
  ...
  absl::StatusOr<GraphNodeHandleSet> GetCmdTailNodes(Index cmd_idx) const {
 ...
 private:
  // UpdateState tracks indices into data structures
  ...
  absl::flat_hash_map<Index, GraphNodeHandleSet> cmd_tail_nodes_;
