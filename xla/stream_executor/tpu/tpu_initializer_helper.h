...
#ifndef XLA_STREAM_EXECUTOR_TPU_TPU_INITIALIZER_HELPER_H_
#define XLA_STREAM_EXECUTOR_TPU_TPU_INITIALIZER_HELPER_H_
...
#endif  // XLA_STREAM_EXECUTOR_TPU_TPU_INITIALIZER_HELPER_H_
