...
#ifndef XLA_STREAM_EXECUTOR_TPU_HOST_COMMAND_HANDLER_H_
#define XLA_STREAM_EXECUTOR_TPU_HOST_COMMAND_HANDLER_H_
...
#endif  // XLA_STREAM_EXECUTOR_TPU_HOST_COMMAND_HANDLER_H_
