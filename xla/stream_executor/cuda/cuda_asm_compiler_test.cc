...
#ifdef ENABLE_LIBNVJITLINK_SUPPORT
...
// Just a helper function that wrap `CompileAndLinkUsingLibNvJitLink`. It makes
...
#endif  // defined(ENABLE_LIBNVJITLINK_SUPPORT)
