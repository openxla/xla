...
tsl::StatusOr<cudnn_frontend::Tensor> CreateCudnnTensor(
    ...
    cudnn_frontend::cudnnBackendTensorReordering_t cudnn_tensor_order_type =
        cudnn_frontend::cudnnBackendTensorReordering_t::
            CUDNN_TENSOR_REORDERING_NONE,
    bool is_value = false) {
  if (cudnn_tensor_order_type !=
          cudnn_frontend::cudnnBackendTensorReordering_t::
              CUDNN_TENSOR_REORDERING_NONE &&
      (CUDNN_VERSION) < 8300) {
...
tsl::StatusOr<cudnn_frontend::Tensor> CreateCudnnMaskTensor(
  ...
  TF_ASSIGN_OR_RETURN(
      ...
      CreateCudnnTensor(mask_dim, mask_stride, 'A', dnn::DataType::kFloat, 1,
                        -1,
                        /*is_virtual*/ false,
...
tsl::StatusOr<cudnn_frontend::Tensor> CreateCudnnSoftmaxFwdTensor(
  ...
  cudnn_frontend::cudnnBackendTensorReordering_t tensor_ordering =
...
GetCudnnOperationGraph(dnn::ConvolutionKind kind, dnn::DataType input_type,
  ...
  cudnn_frontend::cudnnBackendTensorReordering_t tensor_ordering_type =
