...
// CHECK-LABEL: module @result_shardings
module @result_shardings {
  ...
  func.func @while_with_free_variables(
    ...
    // CHECK-DAG:   %[[ADD_1:.*]] = stablehlo.add %iterArg, %arg1
  ...
  // Test that inlined meshes are handled correctly and uninlined at the end.
