...
func.func @manual_computation_no_inputs_no_outputs() {
  ...
  // CHECK-NEXT: } : () -> ()
  // CHECK-NEXT: return
  call @xla.sdy.manual_computation_body_8() : () -> ()
  return
}
...
func.func @manual_computation_zero_dim_inputs(%arg0: tensor<0x16xf32>, %arg1: tensor<16x32xf32>) -> (tensor<0x32xf32>) {
  ...
  %1 = call @xla.sdy.manual_computation_body_9(%c, %0#1) : (tensor<0x8xf32>, tensor<8x32xf32>) -> tensor<0x32xf32>
  %2 = stablehlo.custom_call @xla.sdy.LocalToGlobalShape(%1) {mhlo.frontend_attributes = {xla.sdy.manual_axes = "#sdy<manual_axes{\22b\22}>", xla.sdy.out_shardings = "#sdy.sharding_per_value<[<@mesh_0, [{}, {}], replicated={\22b\22}>]>"}} : (tensor<0x32xf32>) -> tensor<0x32xf32>
...
func.func @xla.sdy.manual_computation_body_9(%arg0: tensor<0x8xf32>, %arg1: tensor<8x32xf32>) -> tensor<0x32xf32> {
