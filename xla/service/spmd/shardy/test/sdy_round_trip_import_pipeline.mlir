...
module @multiple_func_result_shardings attributes {mhlo.frontend_attributes = {xla.sdy.meshes =
  ...
  func.func @shardings_with_size_one_axes(
    ...
    %3 = stablehlo.custom_call @xla.sdy.FuncResultSharding(%1) {mhlo.frontend_attributes = {xla.sdy.sharding = "#sdy.sharding_per_value<[<@mesh2, [{\\\22x\\\22}]>]>"}} : (tensor<32xi32>) -> tensor<32xi32>
    %4 = stablehlo.custom_call @xla.sdy.FuncResultSharding(%2) {mhlo.frontend_attributes = {xla.sdy.sharding = "#sdy.sharding_per_value<[<@mesh2, [{\\\22y\\\22}]>]>"}} : (tensor<32xi32>) -> tensor<32xi32>
