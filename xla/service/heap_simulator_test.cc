...
*/
  ...
  EXPECT_THAT(finder.Find(),
              ::testing::ElementsAre(Chunk::FromOffsetSize(45, 3),
                                     Chunk::FromOffsetSize(48, 3),
                                     Chunk::FromOffsetSize(51, 3)));
}
...
*/
  ...
  EXPECT_THAT(finder.Find(),
              ::testing::ElementsAre(Chunk::FromOffsetSize(51, 3),
                                     Chunk::FromOffsetSize(48, 3),
                                     Chunk::FromOffsetSize(45, 3)));
}
...
*/
  ...
  EXPECT_THAT(finder.Find(),
              ::testing::ElementsAre(Chunk::FromOffsetSize(48, 3),
                                     Chunk::FromOffsetSize(51, 3),
                                     Chunk::FromOffsetSize(45, 3)));
}
...
*/
  ...
  EXPECT_THAT(finder.Find(),
              ::testing::ElementsAre(Chunk::FromOffsetSize(46, 3),
                                     Chunk::FromOffsetSize(40, 3),
                                     Chunk::FromOffsetSize(43, 3)));
}
...
*/
  ...
  EXPECT_THAT(finder.Find(),
              ::testing::ElementsAre(Chunk::FromOffsetSize(47, 3),
                                     Chunk::FromOffsetSize(50, 4),
                                     Chunk::FromOffsetSize(42, 5)));
}
...
*/
  ...
  EXPECT_THAT(finder.Find(),
              ::testing::ElementsAre(Chunk::FromOffsetSize(10, 5),
                                     Chunk::FromOffsetSize(15, 3),
                                     Chunk::FromOffsetSize(18, 4)));
}
...
*/
  ...
  EXPECT_THAT(finder.Find(),
              ::testing::ElementsAre(Chunk::FromOffsetSize(20, 3),
                                     Chunk::FromOffsetSize(23, 3),
                                     Chunk::FromOffsetSize(26, 3)));
}
...
*/
  ...
  Finder finder(free_chunks_per_slice_time, sorted_slice_sizes,
                max_colocation_size, preferred_offset,
                [](int64_t offset) { return offset % 2 == 0; });

  EXPECT_THAT(finder.Find(),
              ::testing::ElementsAre(Chunk::FromOffsetSize(48, 4),
                                     Chunk::FromOffsetSize(52, 4),
                                     Chunk::FromOffsetSize(44, 4)));
}
