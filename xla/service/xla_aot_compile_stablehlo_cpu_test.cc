...
TEST(XlaCompileTest, LoadCpuExecutable) {
  ...
  ASSERT_OK_AND_ASSIGN(ScopedShapedBuffer alpha,
                       client->LiteralToShapedBuffer(
                           alpha_literal, client->default_device_ordinal()));
  ASSERT_OK_AND_ASSIGN(ScopedShapedBuffer x,
                       client->LiteralToShapedBuffer(
                           x_literal, client->default_device_ordinal()));
  ASSERT_OK_AND_ASSIGN(ScopedShapedBuffer y,
                       client->LiteralToShapedBuffer(
  ...
  ASSERT_OK_AND_ASSIGN(Literal axpy_result_literal,
