...
bool AllGatherDynamicSliceCancellation(
    ...
    bool allow_intervening_reshape = false, int64_t min_rank = 1,
    HloPredicate match_partition_id = HloPredicateIsOp<HloOpcode::kPartitionId>,
    HloPredicate match_replica_id = HloPredicateIsOp<HloOpcode::kReplicaId>, bool allow_intervening_bitcast = false, bool allow_multiple_users = false);
...
std::optional<ReduceScatterSpec> MatchWithDynamicSlice(
    ...
    bool is_cross_module = false, bool allow_intervening_bitcast = false, bool allow_multiple_users = false);
