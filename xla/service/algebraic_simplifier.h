...
class AlgebraicSimplifierOptions {
 public:
  ...
  bool executing_on_cpu() const {
    return executing_on_cpu_;
  }
  void set_executing_on_cpu(
      bool executing_on_cpu) {
...
class AlgebraicSimplifierVisitor : public DfsHloRewriteVisitor {
 ...
 private:
  ...
  absl::StatusOr<bool> RemoveDegenerateDimensionFromDot(HloInstruction* dot);
  ...
  absl::StatusOr<bool> RemoveTransposesFromDotOperands(HloInstruction* dot);
