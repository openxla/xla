...
#ifndef XLA_SERVICE_PROFILE_VIZ_UTILS_H_
#define XLA_SERVICE_PROFILE_VIZ_UTILS_H_
...
StatusOr<std::unique_ptr<HloModule>> ReadModule(
    const std::string& profiler_session_id);
...
#endif  // XLA_SERVICE_PROFILE_VIZ_UTILS_H_
