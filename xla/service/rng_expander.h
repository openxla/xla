...
#ifndef TENSORFLOW_COMPILER_XLA_SERVICE_RNG_EXPANDER_H_
#define TENSORFLOW_COMPILER_XLA_SERVICE_RNG_EXPANDER_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_SERVICE_RNG_EXPANDER_H_
