...
// Creates a cuDNN graph, queries cuDNN whether it is valid.
absl::StatusOr<se::gpu::CudnnGraph> CreateGraph(
...
absl::StatusOr<FusionEmissionResult> CuDnnFusion::Emit(
  ...
  TF_ASSIGN_OR_RETURN(se::gpu::CudnnGraph graph, CreateGraph(fusion));
