...
class GpuCompiler : public LLVMCompiler {
 public:
  ...
  // pass a nullptr stream_exec and set a TargetConfig in the CompileOptions, and
  // then call CompileAheadOfTime. See service/xla_compile_main.cc for an example.
