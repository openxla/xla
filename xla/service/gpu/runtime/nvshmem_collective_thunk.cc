...
absl::Status NvshmemCollectiveThunk::AsyncEvents::Initialize(
...
absl::StatusOr<se::Event*> NvshmemCollectiveThunk::AsyncEvents::GetEvent(
    se::StreamExecutor* executor) {
  absl::MutexLock lock(&mu_);
...
NvshmemCollectiveDoneThunk::NvshmemCollectiveDoneThunk(
    ...
    std::shared_ptr<NvshmemCollectiveThunk::AsyncEvents> async_events,
