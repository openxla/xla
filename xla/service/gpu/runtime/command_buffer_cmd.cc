...
std::string CommandBufferCmdString(
    CommandBufferCmdType type) {
  switch (type) {
...
TracedCommandBufferCmd::TracedCommandBufferCmd(
    ExecutionStreamId execution_stream_id, CommandBufferCmdType cmd_type)
    : CommandBufferCmd(execution_stream_id, cmd_type) {}
...
ComputationIdCmd::ComputationIdCmd(ExecutionStreamId execution_stream_id,
    ...
    : CommandBufferCmd(execution_stream_id,
                       CommandBufferCmdType::kComputationIdCmd),
      dest_(dest),
      kind_(kind) {}
...
LaunchCmd::LaunchCmd(ExecutionStreamId execution_stream_id,
    ...
    : CommandBufferCmd(execution_stream_id, CommandBufferCmdType::kLaunchCmd),
...
CustomKernelLaunchCmd::CustomKernelLaunchCmd(
    ...
    : CommandBufferCmd(execution_stream_id,
                       CommandBufferCmdType::kCustomKernelLaunchCmd),
      args_(args.begin(), args.end()),
      args_access_(args_access.begin(), args_access.end()),
...
MemcpyDeviceToDeviceCmd::MemcpyDeviceToDeviceCmd(
    ...
    : CommandBufferCmd(execution_stream_id,
                       CommandBufferCmdType::kMemcpyDeviceToDeviceCmd),
      dst_(dst),
      src_(src),
...
MemzeroCmd::MemzeroCmd(ExecutionStreamId execution_stream_id,
    ...
    : CommandBufferCmd(execution_stream_id, CommandBufferCmdType::kMemzeroCmd),
      dst_(dst) {}
...
Memset32Cmd::Memset32Cmd(ExecutionStreamId execution_stream_id,
    ...
    : CommandBufferCmd(execution_stream_id, CommandBufferCmdType::kMemset32Cmd),
      dst_(dst),
...
IfCmd::IfCmd(ExecutionStreamId execution_stream_id,
    ...
    : CommandBufferCmd(execution_stream_id, CommandBufferCmdType::kIfCmd),
      pred_(pred),
...
IfElseCmd::IfElseCmd(ExecutionStreamId execution_stream_id,
    ...
    : CommandBufferCmd(execution_stream_id, CommandBufferCmdType::kIfElseCmd),
      pred_(pred),
      then_commands_(std::move(then_commands)),
...
CaseCmd::CaseCmd(ExecutionStreamId execution_stream_id,
    ...
    : CommandBufferCmd(execution_stream_id, CommandBufferCmdType::kCaseCmd),
      index_(index),
...
ForCmd::ForCmd(ExecutionStreamId execution_stream_id, int32_t num_iterations,
    ...
    : CommandBufferCmd(execution_stream_id, CommandBufferCmdType::kForCmd),
...
WhileCmd::WhileCmd(ExecutionStreamId execution_stream_id,
                   ...
                   CommandBufferCmdSequence body_commands)
    : CommandBufferCmd(execution_stream_id, CommandBufferCmdType::kWhileCmd),
      pred_(pred),
...
GemmCmd::GemmCmd(ExecutionStreamId execution_stream_id, GemmConfig config,
    ...
    : TracedCommandBufferCmd(execution_stream_id, CommandBufferCmdType::kGemmCmd),
...
CublasLtCmd::CublasLtCmd(
    ...
    : TracedCommandBufferCmd(execution_stream_id, CommandBufferCmdType::kCublasLtCmd),
...
CuDnnCmd::CuDnnCmd(ExecutionStreamId execution_stream_id,
    ...
    : TracedCommandBufferCmd(execution_stream_id,
                             CommandBufferCmdType::kCuDnnCmd),
...
BarrierCmd::BarrierCmd(ExecutionStreamId execution_stream_id,
    ...
    : CommandBufferCmd(execution_stream_id, CommandBufferCmdType::kBarrierCmd),
...
AllReduceCmd::AllReduceCmd(
    ...
    : CollectiveCmd(execution_stream_id, async_from_stream_id, nccl_api,
                    std::move(config), CommandBufferCmdType::kAllReduceCmd),
...
ReduceScatterCmd::ReduceScatterCmd(
    ...
    absl::Span<const NcclCollectiveThunk::Buffer> buffers)
    : CollectiveCmd(execution_stream_id, async_from_stream_id, nccl_api,
                    std::move(config), CommandBufferCmdType::kReduceScatter),
      reduction_kind_(reduction_kind),
      buffers_(buffers.begin(), buffers.end()) {}
...
AllGatherCmd::AllGatherCmd(
    ...
    absl::Span<const NcclCollectiveThunk::Buffer> buffers)
    : CollectiveCmd(execution_stream_id, async_from_stream_id, nccl_api,
                    std::move(config), CommandBufferCmdType::kAllGatherCmd),
      buffers_(buffers.begin(), buffers.end()) {}
...
CollectiveBroadcastCmd::CollectiveBroadcastCmd(
    ...
    : CollectiveCmd(execution_stream_id, async_from_stream_id, nccl_api,
                    std::move(config),
                    CommandBufferCmdType::kCollectiveBroadcastCmd),
      buffers_(buffers.begin(), buffers.end()) {}
