...
static Status RunRepeated(int32_t count, absl::FunctionRef<Status()> to_run) {
  if (count != 0) {
...
#if XLA_ENABLE_XCCL
static StatusOr<NcclComm::Lock> GetNcclComm(
...
static StatusOr<std::vector<DeviceBufferPair>> GetDeviceBufferPairs(
