...
ENTRY e {
  ...
  ROOT _ = f16[65536,32] fusion(p0, p1), kind=kCustom, calls=triton_dot,
    backend_config="{\"fusion_backend_config\": {kind: \"__triton_gemm\", triton_gemm_config: {\"block_m\":\"32\",\"block_n\":\"32\",\"block_k\":\"32\",\"split_k\":\"1\",\"num_stages\":\"1\",\"num_warps\":\"1\",\"num_ctas\":\"1\",\"cluster_dims\":{\"x\":\"1\",\"y\":\"1\",\"z\":\"1\"},\"enable_warp_specialization\":\"false\",\"enable_tma\":\"false\"}}}"
}
)";
