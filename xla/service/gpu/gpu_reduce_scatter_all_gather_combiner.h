...
class ReduceScatterAllGatherCombiner : public HloModulePass {
 public:
  ReduceScatterAllGatherCombiner() = default;
  absl::string_view name() const override { return "reduce-scatter-all-gather-combiner"; }
