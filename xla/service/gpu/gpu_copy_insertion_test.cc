...
TEST_F(GpuCopyInsertionDoubleBufferingTest, DoubleBufferShouldNotInsertCopy) {
  const char* const kModuleString = R"(
...
TEST_F(GpuCopyInsertionDoubleBufferingTest,
       DoubleBufferShouldNotInsertCopyParalellPaths) {
  const char* const kModuleString = R"(
HloModule all_gather_overlapping
condition {
...
TEST_F(GpuCopyInsertionDoubleBufferingTest,
       DoubleBufferShouldNotInsertCopyParalellPathsddTripCount) {
  const char* const kModuleString = R"(
HloModule all_gather_overlapping
condition {
  input_tuple = (f32[1,128], f32[1,128], f32[2,128], s32[]) parameter(0)
