...
TEST_F(TritonTest, NestedReducerFusionGetsCodegenedCorrectly) {
...
ENTRY entry {
  ...
  EXPECT_THAT(
      TritonWrapper("test_fn", triton_dot_fusion,
...
TEST_F(TritonTest, TestGenericEmitterReductionFusion) {
  const std::string kHloText = R"(
HloModule t
add {
  Arg_0 = f32[] parameter(0)
