...
using CkGemmKernel = CkGemmKernelHelper<
  ...
  ck_tile::half_t, ck_tile::half_t, // ADataType, BDataType
  float, ck_tile::half_t, // AccDataType, CDataType
...
XLA_GPU_DEFINE_CK_GEMM_TRAITS(F16xF16ToF16, CkGemmKernel::GemmKernel);
