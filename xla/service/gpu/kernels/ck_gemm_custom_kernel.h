...
#ifndef XLA_SERVICE_GPU_KERNELS_CK_GEMM_CUSTOM_KERNEL_H_
#define XLA_SERVICE_GPU_KERNELS_CK_GEMM_CUSTOM_KERNEL_H_
...
#endif  // XLA_SERVICE_GPU_KERNELS_CK_GEMM_CUSTOM_KERNEL_H_
