  ...
  if (name == "NVIDIA RTX A6000") {
    ...
    EXPECT_THAT(
        ...
        ::testing::FieldsAre(
            ...
            test_info.shared_memory_per_core,
            test_info.threads_per_core_limit,
            test_info.core_count,
            test_info.fpus_per_core,
            test_info.block_dim_limit_x,
            test_info.block_dim_limit_y,
            test_info.block_dim_limit_z,
            test_info.memory_bandwidth,
