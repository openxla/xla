...
ENTRY entry {
  ...
  GpuLayoutAssignment layout_assignment(
      &computation_layout, se::RocmComputeCapability::EarliestRDNASupport(), GetDnnVersion(),
      GetDeviceDescription());
...
ENTRY entry {
  ...
  GpuLayoutAssignment layout_assignment(
      &computation_layout, se::RocmComputeCapability::EarliestCDNASupport(), GetDnnVersion(),
      GetDeviceDescription());
