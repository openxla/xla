...
TEST_F(HloInstructionTest, GetSetStatisticsViz) {
  ...
  Statistic statistic;
  statistic.set_value_being_tracked("stat-1");
  statistic.set_value_being_tracked("30.0");
  ...
  statistic.set_value_being_tracked("40.0");
...
TEST_F(HloInstructionTest, StringifyStatisticsViz) {
  ...
  auto CreateStatisticsVizWithStatistics =
    ...
    auto create_statistic = [](absl::string_view statistic_name,
      ...
      Statistic statistic;
      statistic.set_value_being_tracked(statistic_name);
      statistic.set_percentage(statistic_value);
      return statistic;
    };
