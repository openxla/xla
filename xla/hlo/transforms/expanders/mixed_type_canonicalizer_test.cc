...
class MixedTypeCanonicalizerTest : public HloHardwareIndependentTestBase {};

TEST_F(MixedTypeCanonicalizerTest, DotBf16ToS32) {
...
TEST_F(MixedTypeCanonicalizerTest, ConvolutionBf16ToS32) {
  absl::string_view hlo_string = R"(
HloModule module
...
TEST_F(MixedTypeCanonicalizerTest, NoChangeNeeded) {
  absl::string_view hlo_string = R"(
HloModule module
