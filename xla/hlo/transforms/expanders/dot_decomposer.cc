...
HloInstruction* CanonicalizeOperand(
    ...
    absl::Span<int64_t>& canonical_batch_dims,
  ...
  std::vector<int64_t> reshape_dims = canonical_batch_dims;
  std::vector<bool> reshape_dynamic_dims = canonical_batch_dynamic_dims;
  if (contracting_dim_as_most_minor) {
