...
//   compute = f32[512,256] some-computation(p0, p1)
//   ROOT tuple = (f32[512,256], f32[512,256]) tuple(compute, p1)
// }
//
// while_cond {
...
//   while = (f32[512,256], f32[512,256]) while(ag0, ag1), condition=while_cond, body=while_body
// }
// clang-format on
