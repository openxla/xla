      ...
      switch (shuffle_instruction->mode()) {
        ...
        case ShuffleMode::kPermute: {
          ...
          ABSL_ASSIGN_OR_RETURN(mlir::Value start_indices,
                                ImportShufflePermuteStartIndices(
                                    shuffle_instruction, func_builder, loc));
...
absl::StatusOr<Value> HloFunctionImporter::ImportShufflePermuteStartIndices(
  ...
  ABSL_ASSIGN_OR_RETURN(Literal indices,
