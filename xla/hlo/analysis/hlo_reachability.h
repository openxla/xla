...
class HloReachabilityMap {
 public:
  ...
  HloReachabilityMap(const HloReachabilityMap& b) = delete;
  HloReachabilityMap& operator=(HloReachabilityMap& b) = delete;
 ...
 private:
  ...
  // allocate groups of up to 1024 bitsets at a time.
