...
// Computations the propagation schedule does not reach from the entry through
// call, while, conditional or async-start (here a computation nothing calls
// and one a custom call names) are propagated first, in post order, so their
// phi ids come before the reached phis and do not depend on instruction
// addresses.
...
swap_cond {
  scp = (f32[], f32[]) parameter(0)
  ROOT sc = pred[] constant(true)
}

swap_body {
  sbp = (f32[], f32[]) parameter(0)
  sa = f32[] get-tuple-element(sbp), index=0
  sb = f32[] get-tuple-element(sbp), index=1
  ROOT sbr = (f32[], f32[]) tuple(sb, sa)
}

embedded {
  ex = f32[] parameter(0)
  ey = f32[] parameter(1)
  et = (f32[], f32[]) tuple(ex, ey)
  ew = (f32[], f32[]) while(et), condition=swap_cond, body=swap_body
  ROOT eg = f32[] get-tuple-element(ew), index=0
}
...
dead_body {
  ...
  dsum = f32[] add(da, db)
  ROOT dbr = (f32[], f32[]) tuple(dsum, da)
}

dead {
  dp0 = f32[] parameter(0)
  dp1 = f32[] parameter(1)
  dinit = (f32[], f32[]) tuple(dp0, dp1)
  ROOT dw = (f32[], f32[]) while(dinit), condition=dead_cond, body=dead_body
}
...
ENTRY main {
  x = f32[] parameter(0)
  y = f32[] parameter(1)
  cc = f32[] custom-call(x, y), custom_call_target="foo", called_computations={embedded}
  t = (f32[], f32[]) tuple(cc, y)
  ...
  EXPECT_EQ(DumpValues(*analysis), ssa_form ? R"(
0 scp {} pos[scp {}] uses[]
1 scp {0} pos[scp {0}] uses[]
2 scp {1} pos[scp {1}] uses[]
3 sc pos[sc] uses[]
4 sbp {} pos[sbp {}] uses[sa:0{},sb:0{}]
5 sbp {0} pos[sbp {0},sa,sbr {1}] uses[sbr:1{}]
6 sbp {1} pos[sbp {1},sb,sbr {0}] uses[sbr:0{}]
7 sbr {} pos[sbr {}] uses[]
8 ex pos[ex,et {0}] uses[ew:0{0}]
9 ey pos[ey,et {1}] uses[ew:0{1}]
10 et {} pos[et {}] uses[ew:0{}]
11 dc pos[dc] uses[]
12 dsum pos[dsum,dbr {0}] uses[dbr:0{}]
13 dbr {} pos[dbr {}] uses[]
14 dp0 pos[dp0,dinit {0}] uses[dw:0{0}]
15 dp1 pos[dp1,dinit {1}] uses[dw:0{1}]
16 dinit {} pos[dinit {}] uses[dw:0{}]
17 lc pos[lc] uses[]
18 lbr {} pos[lbr {}] uses[]
19 x pos[x] uses[cc:0{}]
20 y pos[y,t {1}] uses[cc:1{},w:0{1}]
21 cc pos[cc,t {0}] uses[w:0{0}]
22 t {} pos[t {}] uses[w:0{}]
23 ew {} phi pos[ew {}] uses[eg:0{}]
24 ew {0} phi pos[ew {0},eg] uses[eg:0{0}]
25 ew {1} phi pos[ew {1}] uses[]
26 dcp {} phi pos[dcp {}] uses[]
27 dbp {} phi pos[dbp {}] uses[da:0{},db:0{}]
28 dcp {0} phi pos[dcp {0}] uses[]
29 dcp {1} phi pos[dcp {1}] uses[]
30 dbp {0} phi pos[dbp {0},da,dbr {1}] uses[dsum:0{},dbr:1{}]
31 dbp {1} phi pos[dbp {1},db] uses[dsum:1{}]
32 dw {} phi pos[dw {}] uses[]
33 dw {0} phi pos[dw {0}] uses[]
34 dw {1} phi pos[dw {1}] uses[]
35 lcp {} phi pos[lcp {}] uses[]
36 lbp {} phi pos[lbp {}] uses[la:0{},lb:0{}]
37 lcp {0} phi pos[lcp {0}] uses[]
38 lcp {1} phi pos[lcp {1}] uses[]
39 lbp {0} phi pos[lbp {0},la,lbr {1}] uses[lbr:1{}]
40 lbp {1} phi pos[lbp {1},lb,lbr {0}] uses[lbr:0{}]
41 w {} phi live_out pos[w {}] uses[]
42 w {0} phi live_out pos[w {0}] uses[]
43 w {1} phi live_out pos[w {1}] uses[]
)"
                                            : R"(
0 scp {} pos[scp {}] uses[]
1 scp {0} pos[scp {0}] uses[]
...
3 sc pos[sc] uses[]
4 sbp {} pos[sbp {}] uses[sa:0{},sb:0{}]
5 sbp {0} pos[sbp {0},sa,sbr {1},ew {1}] uses[sbr:1{}]
6 sbp {1} pos[sbp {1},sb,sbr {0},ew {0},eg] uses[sbr:0{},eg:0{0}]
7 sbr {} pos[sbr {},ew {}] uses[eg:0{}]
8 ex pos[ex,et {0},ew {0},eg] uses[ew:0{0},eg:0{0}]
9 ey pos[ey,et {1},ew {1}] uses[ew:0{1}]
10 et {} pos[et {},ew {}] uses[ew:0{},eg:0{}]
11 dc pos[dc] uses[]
12 dsum pos[dsum,dcp {0},dcp {1},dbp {0},dbp {1},da,db,dbr {0},dbr {1},dw {0},dw {1}] uses[dbr:0{},dsum:0{},dbr:1{},dsum:1{}]
13 dbr {} pos[dbr {},dcp {},dbp {},dw {}] uses[da:0{},db:0{}]
14 dp0 pos[dp0,dcp {0},dcp {1},dbp {0},dbp {1},da,db,dbr {1},dinit {0},dw {0},dw {1}] uses[dsum:0{},dbr:1{},dsum:1{},dw:0{0}]
15 dp1 pos[dp1,dcp {1},dbp {1},db,dinit {1},dw {1}] uses[dsum:1{},dw:0{1}]
16 dinit {} pos[dinit {},dcp {},dbp {},dw {}] uses[dw:0{},da:0{},db:0{}]
17 lc pos[lc] uses[]
18 lbr {} live_out pos[lbr {},lcp {},lbp {},w {}] uses[la:0{},lb:0{}]
19 x pos[x] uses[cc:0{}]
20 y live_out pos[y,lcp {0},lcp {1},lbp {0},lbp {1},la,lb,lbr {0},lbr {1},t {1},w {0},w {1}] uses[cc:1{},lbr:1{},lbr:0{},w:0{1}]
21 cc live_out pos[cc,lcp {0},lcp {1},lbp {0},lbp {1},la,lb,lbr {0},lbr {1},t {0},w {0},w {1}] uses[lbr:1{},lbr:0{},w:0{0}]
22 t {} live_out pos[t {},lcp {},lbp {},w {}] uses[w:0{},la:0{},lb:0{}]
)");
}
