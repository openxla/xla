...
TEST_F(HloAliasAnalysisTest,
       MegachipLateBindingAsyncChain_CrossCall_1) {
  absl::string_view hlo_string = R"(
HloModule Module
...
TEST_F(HloAliasAnalysisTest,
       MegachipLateBindingAsyncChain_CrossCall_2) {
  absl::string_view hlo_string = R"(
HloModule Module
...
TEST_F(HloAliasAnalysisTest,
       MegachipLateBindingAsyncChain_CrossCall_3) {
  absl::string_view hlo_string = R"(
HloModule Module
...
TEST_F(HloAliasAnalysisTest,
       MegachipLateBindingAsyncChain_CrossOperands) {
  absl::string_view hlo_string = R"(
HloModule Module
