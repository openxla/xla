...
def autogenerated_regression_test(name, hlo_files, **kwargs):
    for hlo in hlo_files:
        # It really *seems* like we should not be passing hlo to
        # AUTOGENERATED_REGRESSION_HLO_PATH, but it doesn't seem like there's
        ...
        xla_test(
            ...
            srcs = ["autogenerated_regression_test_template.cc"],
            local_defines = [
                "AUTOGENERATED_REGRESSION_TEST_NAME={}".format(test_case_name),
                'AUTOGENERATED_REGRESSION_HLO_PATH=\\"{}\\"'.format(hlo),
            ],
            data = [hlo],
            deps = [
