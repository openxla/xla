...
ENTRY TestComputation {
  ...
  EXPECT_TRUE(RunAndCompare(absl::StrReplaceAll(kHlo+kHloRELU, {{"f32", "f16"}}), ErrorSpec{0.03, 0.03}));
  EXPECT_TRUE(RunAndCompare(absl::StrReplaceAll(kHloNoPad+kHloRELU, {{"f32", "f16"}}), ErrorSpec{0.03, 0.03}));
}
