...
XLA_TEST_F(ConvertTest, ConvertF16F8e4m3Roundtrip) {
  ...
  struct TestCase {
    ...
    float expected_roundtrip;
      ...
      {0x0.1p-6, 0},           // Largest number that underflows
      {0x0.104p-6, 0x0.2p-6},  // Smallest number that doesn't underflow
...
XLA_TEST_F(ConvertTest, DISABLED_ON_CPU(ConvertF32F8e4m3Roundtrip)) {
  ...
  struct TestCase {
    ...
    float expected_roundtrip;
      ...
      {0x0.91p-6, 0x0.Ap-6},      // Round-to-nearest up
      {0x0.1p-6, 0},              // Largest number that underflows
      {0x0.100002p-6, 0x0.2p-6},  // Smallest number that doesn't underflow
...
XLA_TEST_F(ConvertTest, DISABLED_ON_CPU(ConvertF32F8e3m4Roundtrip)) {
  ...
  struct TestCase {
    ...
    float expected_roundtrip;
      ...
      {0x0.89p-2, 0x0.9p-2},      // Round-to-nearest up
      {0x0.08p-2, 0},             // Largest number that underflows
      {0x0.080002p-2, 0x0.1p-2},  // Smallest number that doesn't underflow
