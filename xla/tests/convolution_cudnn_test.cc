...
ENTRY TestComputation {
  ...
  cudnn-conv-bias-activation.3 = (s8[4,48,48,64]{3,2,1,0}, u8[0]{0}) custom-call(input, filter, convert.1),
      ...
      backend_config="{\"operation_queue_id\":\"0\",\"wait_on_operation_queues\":[],\"cudnn_conv_backend_config\":{\"activation_mode\":\"2\",\"conv_result_scale\":1,\"side_input_scale\":0,\"algorithm\":{
...
ENTRY TestComputation {
  ...
  %conv = (s8[4,48,48,64], u8[0]) custom-call(%input, %filter),
        ...
        backend_config="{\"operation_queue_id\":\"0\",\"wait_on_operation_queues\":[],\"cudnn_conv_backend_config\":{\"activation_mode\":\"0\",\"conv_result_scale\":1,\"side_input_scale\":0}}"
