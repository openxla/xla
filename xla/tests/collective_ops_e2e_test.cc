...
TEST_F(CollectiveOpsTestE2E, MultipleModuleDifferentDeviceGroupsShouldRun) {
  ...
  TF_ASSERT_OK_AND_ASSIGN(std::vector<Literal> results_2,
                          ExecuteReplicated(std::move(module_2),
                                            {{&input_literal2_1},
                                             {&input_literal2_2},
                                             {&input_literal2_3},
                                             {&input_literal2_4}},
                                            /*device_assignment=*/nullptr,
                                            /*num_replicas=*/kNumReplicas_2,
                                            /*run_hlo_passes=*/true));
}
