...
def execute_with_python_values(
    executable: LoadedExecutable, arguments: Sequence[Any], backend: Client
) -> Sequence[numpy.ndarray]: ...
def execute_with_python_values_replicated(
    executable: LoadedExecutable,
    arguments: Sequence[Sequence[Any]],
    backend: Client,
) -> Sequence[Sequence[numpy.ndarray]]: ...
def shape_from_pyval(pyval: Any, layout: Sequence[int] | None = ...) -> Any: ...
...
def make_tfrt_tpu_c_api_device_topology(
    topology_name: str | None = ..., **kwargs
) -> DeviceTopology: ...
def get_topology_for_devices(devices: list[Device]) -> DeviceTopology: ...
def make_tpu_client(library_path: str | None) -> Client: ...
