...
struct ExecuteOptions {
  ...
  // Execution stream ID identifies the series of executions that must follow
  // program order.  Executions with different execution stream IDs may be
  // executed in any order and concurrently.
