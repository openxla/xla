...
TEST(PrimitiveUtilTest, CastPreservesValues) {
  ...
  std::cout << "=== PrimitiveType_ARRAYSIZE: " << PrimitiveType_ARRAYSIZE
            << std::endl;
  std::cout << "=== sizeof(expecteds) : " << sizeof(expecteds) << std::endl;
  std::cout << "=== sizeof(expecteds[0]) : " << sizeof(expecteds[0])
            << std::endl;
