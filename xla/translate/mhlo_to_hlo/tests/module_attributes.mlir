...
// expected-error@+1 {{dynamic_parameter_binding: parameters 5 out of range. main has only 2 arguments}}
module attributes {
...
// expected-error@+1 {{dynamic_parameter_binding: parameters 3 out of range. main has only 2 arguments}}
module attributes {
 mhlo.dynamic_parameter_bindings = [
   #mhlo.dynamic_parameter_binding<
     dynamic_param_num = 0,
...
// expected-error@+1 {{dynamic_parameter_binding: outputs 3 out of range. main has only 0 results}}
module attributes {
 mhlo.dynamic_parameter_bindings = [
   #mhlo.dynamic_parameter_binding<
     dynamic_param_num = 0,
