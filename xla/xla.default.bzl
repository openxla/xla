...
def xla_py_strict_test(name, deps = None, data = None, env = None, **kwargs):
    ...
    # For hermetic builds, python tests need to have the CUDA libraries in their $LD_LIBRARY_PATH in
    # order to find them.
