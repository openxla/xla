...
class CollectivesRegistry {
 public:
  ...
  // Return a specific collectives implementation by name for the given platform.
  static absl::StatusOr<Collectives*> Get(absl::string_view platform_name,
                                          absl::string_view implementation_name);
};
