...
absl::StatusOr<std::optional<Shape>> InferScalarBroadcastShape(
...
XlaOp XlaBuilder::TernaryOp(HloOpcode triop, XlaOp lhs, XlaOp rhs, XlaOp ehs) {
  return ReportErrorOrReturn([&]() -> absl::StatusOr<XlaOp> {
    ...
    absl::StatusOr<const Shape> status_or_shape =
        ShapeInference::InferTernaryOpShape(triop, *lhs_shape, *rhs_shape,
                                            *ehs_shape);
