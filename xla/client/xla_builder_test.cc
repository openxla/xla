...
TEST_F(XlaBuilderTest, DynamicParameter) {
  ...
  ASSERT_IS_OK(b.SetDynamicBinding(/*dynamic_param_num=*/1,
...
TEST_F(XlaBuilderTest, DynamicUnary) {
  ...
  auto p0 = Parameter(&b, 0, tuple_param_shape, "p0");
  ASSERT_IS_OK(b.SetDynamicBinding(/*dynamic_param_num=*/0,
                                   /*dynamic_param_indices=*/{1},
                                   /*target=*/DynamicParameterBinding::kParam,
                                   /*target_num=*/0,
                                   /*target_indices=*/{0},
                                   /*target_dim_num=*/0));
