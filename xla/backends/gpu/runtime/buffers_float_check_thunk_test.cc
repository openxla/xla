...
TEST_F(BuffersDebugFloatCheckThunkTest, CalculatesNanCounts) {
  ...
  EXPECT_THAT(entries,
              UnorderedElementsAre(AllOf(
                  NanCountIs(2), InfCountIs(1), ZeroCountIs(1021),
                  IsEntryWithMetadata(
                      metadata_store,
                      Metadata{
...
TEST_F(BuffersDebugFloatCheckThunkTest,
  ...
  EXPECT_THAT(entries,
              UnorderedElementsAre(AllOf(
                  NanCountIs(2), InfCountIs(1), ZeroCountIs(509),
                  IsEntryWithMetadata(
                      metadata_store,
                      Metadata{
                          /*thunk_id=*/ThunkId(123),
...
TEST_F(BuffersDebugFloatCheckThunkTest,
  ...
  EXPECT_THAT(entries,
              UnorderedElementsAre(AllOf(
                  NanCountIs(3), InfCountIs(2), ZeroCountIs(1),
                  MinValueIs(0.0f), MaxValueIs(1.0f),
                  IsEntryWithMetadata(
                      metadata_store,
                      Metadata{
                          /*thunk_id=*/ThunkId(123),
...
TEST_F(BuffersDebugFloatCheckThunkTest, DoesNotAttemptLaunchingWithZeroBlocks) {
  ...
  // Setup memory allocations for the log and input
  BufferAllocation alloc(/*index=*/0,
                         /*size=*/kTotalDeviceMemoryBytes,
                         /*color=*/0);
  BufferAllocation::Slice log_slice(&alloc, /*offset=*/0, kLogSize);
...
TEST_F(BuffersDebugFloatCheckThunkTest,
  ...
  EXPECT_THAT(entries,
              UnorderedElementsAre(AllOf(
                  NanCountIs(3), InfCountIs(2), ZeroCountIs(1), MinValueIs(0.0),
                  MaxValueIs(1.0),
                  IsEntryWithMetadata(
                      metadata_store,
                      Metadata{
...
TEST_F(BuffersDebugFloatCheckThunkTest, HandlesInputsWithDifferentTypes) {
  static constexpr size_t kLogSize =
      BufferDebugLog<BufferDebugFloatCheckEntry>::RequiredSizeForEntries(10);
  static constexpr size_t kTmpSizeElems = 1024;
  static constexpr size_t kTmpSizeBytes = kTmpSizeElems * sizeof(uint32_t);
  static constexpr size_t kInputElems = 1024;
  static constexpr size_t kInputSizeBf16Bytes =
      kInputElems * sizeof(Eigen::bfloat16);
  static constexpr size_t kInputSizeF32Bytes = kInputElems * sizeof(float);
  static constexpr size_t kTotalDeviceMemoryBytes =
      kLogSize + kTmpSizeBytes + kInputSizeBf16Bytes + kInputSizeF32Bytes;
  // Setup memory allocations for the log and inputs
  BufferAllocation alloc(/*index=*/0,
                         /*size=*/kTotalDeviceMemoryBytes,
                         /*color=*/0);
