...
using CommandType ABSL_DEPRECATE_AND_INLINE() = CommandType;

ABSL_DEPRECATE_AND_INLINE()
inline std::string CommandBufferCmdString(CommandType type) {
  return CommandTypeString(type);
}
...
using CommandBufferCmd ABSL_DEPRECATE_AND_INLINE() = Command;
using CommandBufferCmdSequence ABSL_DEPRECATE_AND_INLINE() = CommandSequence;
...
class GemmCmd : public TracedCommand {
 public:
...
class CublasLtCmd : public TracedCommand, public CublasLtMatmulThunk {
 public:
