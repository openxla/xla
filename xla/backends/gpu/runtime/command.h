...
class Command {
 public:
  ...
  struct RecordParams {
    ...
    // allocation indices are sorted. CommandExecutor and individual
  ...
  virtual absl::InlinedVector<BufferUse, 4> buffers() const { return {}; }
  ...
  absl::Span<const ResourceUse> resources() const { return resources_; }
