...
class CommandExecutor {
 public:
  ...
  // no extra resource uses are added. Construction mode is derived from the
  // commands themselves: if all commands are kCapture, the executor is
  // kCapture; otherwise it is kExplicit.
