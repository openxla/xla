...
absl::Status RecvCmd::Record(const Thunk::ExecuteParams& execute_params,
                             RecordParams& record_params) {
  ...
  return RecordTracedCommand(execute_params, record_params, trace);
}

CommandBufferCmd::BufferUseVector RecvCmd::buffers() const {
  BufferUseVector buffer_usage;
...
absl::Status SendCmd::Record(const Thunk::ExecuteParams& execute_params,
                             RecordParams& record_params) {
  DeviceBufferPair device_buffer_pair{
      config().operand_element_type[0],
      buffer_.element_count,
...
CommandBufferCmd::BufferUseVector SendCmd::buffers() const {
  BufferUseVector buffer_usage;
  buffer_usage.emplace_back(BufferUse::Read(buffer_.source_buffer));
  buffer_usage.emplace_back(BufferUse::Write(buffer_.destination_buffer));
  return buffer_usage;
