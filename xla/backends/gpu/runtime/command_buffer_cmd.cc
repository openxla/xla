...
absl::Status TracedCommandBufferCmd::RecordTracedCommandBuffer(
  ...
  if (create) {
    ...
    VLOG(5) << "Update nested command buffer.";
    TF_RETURN_IF_ERROR(
...
absl::Status ChildCmd::Record(const Thunk::ExecuteParams& execute_params,
  ...
  if (create) {
    TF_ASSIGN_OR_RETURN(
        ...
        std::move(execute_params.stream->parent()->CreateCommandBuffer(
            se::CommandBuffer::Mode::kNested)));
    TF_ASSIGN_OR_RETURN(node_, command_buffer->CreateChildNode(
                                   ToDependentNodes(), *child_command_buffer_));
  }
  return child_cmds_->Record(execute_params, record_params,
...
absl::Status IfCmd::Record(const Thunk::ExecuteParams& execute_params,
  ...
  if (create) {
    ...
    TF_ASSIGN_OR_RETURN(set_cond_handle_kernel_node_,
                        command_buffer->CreateSetIfConditionKernelNode(
    ...
    TF_RETURN_IF_ERROR(command_buffer->UpdateSetIfConditionKernelNode(
...
absl::Status IfElseCmd::Record(const Thunk::ExecuteParams& execute_params,
  ...
  if (create) {
    ...
    TF_ASSIGN_OR_RETURN(else_cond_handle_,
                        command_buffer->CreateConditionalHandle());
    TF_ASSIGN_OR_RETURN(set_cond_handle_kernel_node_,
                        command_buffer->CreateSetIfElseConditionKernelNode(
                            ToDependentNodes(), then_cond_handle_,
    ...
    TF_RETURN_IF_ERROR(command_buffer->UpdateSetIfElseConditionKernelNode(
  ...
  if (create) {
    ...
    for (int64_t i = 0; i < set_case_handle_batches_num; ++i) {
      ...
      TF_ASSIGN_OR_RETURN(
          ...
          command_buffer->CreateSetCaseConditionKernelNode(
              ToDependentNodes(), case_branch_handles_[batch_offset + 0],
    ...
    for (int64_t i = 0; i < set_case_handle_batches_num; ++i) {
      batch_offset += i * kBranchBatchSize;
      bool enable_conditional_default = (i == set_case_handle_batches_num - 1);
      TF_RETURN_IF_ERROR(command_buffer->UpdateSetCaseConditionKernelNode(
...
absl::Status LaunchSetForConditionKernelCmd::Record(
  ...
  if (create) {
    TF_ASSIGN_OR_RETURN(
        node_, command_buffer->CreateSetForConditionKernelNode(
                   ToDependentNodes(), cond_handle_,
                   se::DeviceMemory<int32_t>(loop_counter), num_iterations_));
  } else {
    TF_RETURN_IF_ERROR(command_buffer->UpdateSetForConditionKernelNode(
...
CommandBufferCmd::BufferUseVector LaunchSetForConditionKernelCmd::buffers() {
...
//===----------------------------------------------------------------------===//
// LaunchSetWhileConditionKernelCmd
//===----------------------------------------------------------------------===//

LaunchSetWhileConditionKernelCmd::LaunchSetWhileConditionKernelCmd(
    GraphConditionalHandle cond_handle, BufferAllocation::Slice pred)
    : CommandBufferCmd(CommandBufferCmdType::kLaunchSetWhileConditionKernelCmd),
      cond_handle_(cond_handle),
      pred_(pred) {}

absl::Status LaunchSetWhileConditionKernelCmd::Record(
    const Thunk::ExecuteParams& execute_params,
    const RecordParams& record_params, se::CommandBuffer* command_buffer,
    bool create) {
  se::DeviceMemoryBase pred =
  ...
  if (create) {
    TF_ASSIGN_OR_RETURN(
        node_,
        command_buffer->CreateSetWhileConditionKernelNode(
            ToDependentNodes(), cond_handle_, se::DeviceMemory<bool>(pred)));
  } else {
    TF_RETURN_IF_ERROR(command_buffer->UpdateSetWhileConditionKernelNode(
        node_, cond_handle_, se::DeviceMemory<bool>(pred)));
  }
  return absl::OkStatus();
}

CommandBufferCmd::BufferUseVector LaunchSetWhileConditionKernelCmd::buffers() {
...
absl::Status WhileCmd::Record(const Thunk::ExecuteParams& execute_params,
  ...
  if (create) {
    ...
    initialize_commands_.Append(
        std::make_unique<LaunchSetWhileConditionKernelCmd>(cond_handle_,
                                                           pred_));
    TF_ASSIGN_OR_RETURN(
        initialize_command_buffer_,
        std::move(execute_params.stream->parent()->CreateCommandBuffer(
            se::CommandBuffer::Mode::kNested)));
    ...
    loop_commands_.Append(std::make_unique<LaunchSetWhileConditionKernelCmd>(
        cond_handle_, pred_));
  ...
  return loop_commands_.Record(execute_params, record_params,
...
EmptyCmd::EmptyCmd(DependencySet dependencies)
