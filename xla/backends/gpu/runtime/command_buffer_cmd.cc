...
CommandBufferCmd::CommandBufferDependencies(
...
CommandBufferCmd::BufferUseVector ComputationIdCmd::buffer_uses() const {
...
CommandBufferCmd::BufferUseVector LaunchCmd::buffer_uses() const {
...
CommandBufferCmd::BufferUseVector CustomKernelLaunchCmd::buffer_uses() const {
  BufferUseVector buffers;
  for (int32_t i = 0; i < args_.size(); ++i) {
    buffers.emplace_back(args_[i], args_access_[i]);
  }
...
CommandBufferCmd::BufferUseVector MemcpyDeviceToDeviceCmd::buffer_uses() const {
...
CommandBufferCmd::BufferUseVector MemzeroCmd::buffer_uses() const {
  return {BufferUse::Write(dst_.slice, dst_.shape)};
}
...
CommandBufferCmd::BufferUseVector Memset32Cmd::buffer_uses() const {
...
CommandBufferCmd::BufferUseVector ChildCmd::buffer_uses() const {
...
CommandBufferCmd::BufferUseVector CaseCmd::buffer_uses() const {
  ...
  if (is_unrolled_loop_) {
    auto record_fn =
      ...
      for (int64_t i = 0; i < trip_count_.value(); ++i) {
        ...
        TF_RETURN_IF_ERROR(cond_commands_.Record(execute_params));
        unroll_record_params.external_dependencies =
            cond_commands_.SinkCommands(unroll_record_params);
        unroll_record_params.is_finalize = (i == trip_count_.value() - 1);
        TF_RETURN_IF_ERROR(body_commands_.Record(execute_params));
        unroll_record_params.external_dependencies =
...
CommandBufferCmd::BufferUseVector WhileCmd::buffer_uses() const {
  absl::flat_hash_set<BufferUse> buffers;
...
CommandBufferCmd::BufferUseVector GemmCmd::buffer_uses() const {
  if (workspace_.has_value()) {
...
CommandBufferCmd::BufferUseVector CublasLtCmd::buffer_uses() const {
...
CommandBufferCmd::BufferUseVector CuDnnCmd::buffer_uses() const {
...
CommandBufferCmd::BufferUseVector CustomCallCmd::buffer_uses() const {
  CommandBufferCmd::BufferUseVector buffer_usage;
...
CommandBufferCmd::BufferUseVector AllReduceCmd::buffer_uses() const {
  BufferUseVector buffer_usage;
...
CommandBufferCmd::BufferUseVector ReduceScatterCmd::buffer_uses() const {
  BufferUseVector buffer_usage;
  for (auto& buffer : buffers_) {
    buffer_usage.emplace_back(BufferUse::Read(buffer.source_buffer));
    buffer_usage.emplace_back(BufferUse::Write(buffer.destination_buffer));
...
CommandBufferCmd::BufferUseVector AllToAllCmd::buffer_uses() const {
  BufferUseVector buffer_usage;
  for (auto& buffer : buffers_) {
    buffer_usage.emplace_back(BufferUse::Read(buffer.source_buffer));
    buffer_usage.emplace_back(BufferUse::Write(buffer.destination_buffer));
...
CommandBufferCmd::BufferUseVector AllGatherCmd::buffer_uses() const {
  BufferUseVector buffer_usage;
  for (auto& buffer : buffers_) {
    buffer_usage.emplace_back(BufferUse::Read(buffer.source_buffer));
    buffer_usage.emplace_back(BufferUse::Write(buffer.destination_buffer));
...
CommandBufferCmd::BufferUseVector CollectiveBroadcastCmd::buffer_uses() const {
  BufferUseVector buffer_usage;
  for (auto& buffer : buffers_) {
    buffer_usage.emplace_back(BufferUse::Read(buffer.source_buffer));
    buffer_usage.emplace_back(BufferUse::Write(buffer.destination_buffer));
...
CommandBufferCmd::BufferUseVector CollectivePermuteCmd::buffer_uses() const {
  BufferUseVector buffer_usage;
...
CommandBufferCmd::BufferUseVector DynamicSliceFusionCmd::buffer_uses() const {
...
CommandBufferCmd::BufferUseVector DynamicSliceCopyFusionCmd::buffer_uses()
    const {
  CommandBufferCmd::BufferUseVector buffers;
