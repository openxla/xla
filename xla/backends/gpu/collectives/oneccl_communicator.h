...
#ifndef XLA_BACKENDS_GPU_COLLECTIVES_ONECCL_COMMUNICATOR_H
#define XLA_BACKENDS_GPU_COLLECTIVES_ONECCL_COMMUNICATOR_H
...
#endif  // XLA_BACKENDS_GPU_COLLECTIVES_ONECCL_COMMUNICATOR_H
