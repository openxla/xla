...
#ifndef XLA_BACKENDS_GPU_COLLECTIVES_ROC_MORI_COLLECTIVES_H_
#define XLA_BACKENDS_GPU_COLLECTIVES_ROC_MORI_COLLECTIVES_H_
...
#endif  // XLA_BACKENDS_GPU_COLLECTIVES_ROC_MORI_COLLECTIVES_H_
