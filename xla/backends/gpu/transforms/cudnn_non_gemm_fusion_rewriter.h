...
#ifndef XLA_BACKENDS_GPU_TRANSFORMS_CUDNN_NON_GEMM_FUSION_REWRITER_H_
#define XLA_BACKENDS_GPU_TRANSFORMS_CUDNN_NON_GEMM_FUSION_REWRITER_H_
...
#endif  // XLA_BACKENDS_GPU_TRANSFORMS_CUDNN_NON_GEMM_FUSION_REWRITER_H_
