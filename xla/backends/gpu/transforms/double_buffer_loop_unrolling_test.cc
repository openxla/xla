...
using GpuWhileLoopUnrollingTest = HloHardwareIndependentTestBase;

TEST_F(GpuWhileLoopUnrollingTest, UnrollLoopWithSmallBodyAndTripCount) {
  absl::string_view kModuleString = R"(
condition {
  input_tuple = (s32[]) parameter(0)
  cond = s32[] get-tuple-element(input_tuple), index=0
...
ENTRY main {
  ...
  TF_ASSERT_OK_AND_ASSIGN(
      WhileLoopBackendConfig config,
      while_instruction->backend_config<WhileLoopBackendConfig>());
  EXPECT_EQ(config.known_trip_count().n(), 1);
}

TEST_F(GpuWhileLoopUnrollingTest, DoNotUnrollLoopWithLargeTripCount) {
  absl::string_view kModuleString = R"(
condition {
  input_tuple = (s32[]) parameter(0)
  cond = s32[] get-tuple-element(input_tuple), index=0
...
ENTRY main {
  param_0 = s32[] constant(0)
  tuple = (s32[]) tuple(param_0)
  ROOT while = (s32[]) while(tuple), condition=condition, body=body, backend_config={"known_trip_count":{"n":"1024"}}
})";
...
TEST_F(GpuWhileLoopUnrollingTest, DoNotUnrollNestedLoops) {
  absl::string_view kModuleString = R"(
condition_nested {
  input_tuple = (s32[]) parameter(0)
  cond = s32[] get-tuple-element(input_tuple), index=0
...
TEST_F(GpuWhileLoopUnrollingTest, DoNotUnrollDynamicSliceLoops) {
  absl::string_view kModuleString = R"(
fused_dynamic_slice {
  p0 = s32[4,8,1000000]{2,1,0} parameter(0)
  p1 = s32[] parameter(1)
  c1 = s32[] constant(1)
  c0 = s32[] constant(0)
  ROOT slice = s32[1,1,1000000]{2,1,0} dynamic-slice(p0, p1, c1, c0), dynamic_slice_sizes={1,1,1000000}
}

fused_add {
  p0 = s32[] parameter(0)
  c1 = s32[] constant(1)
  ROOT next_ivar.2 = s32[] add(p0, c1)
}

body {
  p0 = (s32[], s32[4,8,1000000]{2,1,0}, s32[1,1,1000000]{2,1,0}) parameter(0)
  ivar = s32[] get-tuple-element(p0), index=0
  loop_add_fusion = s32[] fusion(ivar), kind=kLoop, calls=fused_add
  input = s32[4,8,1000000]{2,1,0} get-tuple-element(p0), index=1
  loop_dynamic_slice_fusion = s32[1,1,1000000]{2,1,0} fusion(input, ivar), kind=kLoop, calls=fused_dynamic_slice
  ROOT result = (s32[], s32[4,8,1000000]{2,1,0}, s32[1,1,1000000]{2,1,0}) tuple(loop_add_fusion, input, loop_dynamic_slice_fusion)
}
...
condition {
  p0 = (s32[], s32[4,8,1000000]{2,1,0}, s32[1,1,1000000]{2,1,0}) parameter(0)
  ivar = s32[] get-tuple-element(p0), index=0
  ROOT loop_compare_fusion = pred[] fusion(ivar), kind=kLoop, calls=fused_compare
}

ENTRY main {
  zero = s32[] constant(0)
  p0 = s32[4,8,1000000]{2,1,0} parameter(0)
  p1 = s32[1,1,1000000]{2,1,0} parameter(1)
  tuple = (s32[], s32[4,8,1000000]{2,1,0}, s32[1,1,1000000]{2,1,0}) tuple(zero, p0, p1)
  ROOT while = (s32[], s32[4,8,1000000]{2,1,0}, s32[1,1,1000000]{2,1,0}) while(tuple), condition=condition, body=body, backend_config={"known_trip_count":{"n":"6"}}
})";
