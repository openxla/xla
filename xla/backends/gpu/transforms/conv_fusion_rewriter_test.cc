...
class ConvFusionRewriterUnitTest : public HloPjRtGpuTestBase {
 public:
  bool IsCuda() const {
...
TEST_F(ConvFusionRewriterUnitTest, TestReluAfterConvert) {
  MAYBE_SKIP_TEST("I8");
  RunAndMatch(R"(
    HloModule Test
...
TEST_F(ConvFusionRewriterUnitTest, TestConvInt8ToFloatBiasSideInput) {
  MAYBE_SKIP_TEST("I8");
  RunAndMatch(R"(
    HloModule Test
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestBias) {
  // max(0, conv(x, w) + bias);
  TestMatchWithAllTypes(R"(
    HloModule Test
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_Test3D) {
  // max(0, conv(x, w) + bias);
  std::string body = R"(
    HloModule Test
  ...
  if (!IsCuda()) {
    TestMatchWithAllTypes(body + elu);
  }
}

// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestBiasMultiCall) {
  // max(0, conv(x, w) + bias);
  std::string code = R"(
    HloModule Test
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestBiasNoRelu) {
  // conv(x, w) + bias;
  TestMatchWithAllTypes(R"(
    HloModule Test
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestElu) {
  // sum = conv(x, w) + bias
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestRelu6) {
...
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestRelu6OddChannels) {
  if (IsCuda() && !GetCudaComputeCapability().IsAtLeast(
                      se::CudaComputeCapability::kAmpere)) {
    GTEST_SKIP() << "Conv-Bias-Relu6 fusion is supported and recommended with "
                    "the Nvidia Ampere+ GPUs.";
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestLeakyRelu) {
  if (IsCuda() && !GetCudaComputeCapability().IsAtLeast(
                      se::CudaComputeCapability::kAmpere)) {
    GTEST_SKIP()
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestSideInputOnly) {
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestBiasAndSideInput) {
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestScaledConv) {
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestNoCrashOnInf) {
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestConvAndScaledSideInput) {
...
TEST_F(ConvFusionRewriterIntegrationTest,
       DISABLED_TestScaledConvAndScaledSideInput) {
...
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest,
       DISABLED_TestScaledConvAndScaledSideInputWithBias) {
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestMatchMaxZeroOnly) {
...
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest,
       DISABLED_TestPreservesFeatureGroupCount) {
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestConvF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestConvScaledOutputF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestConvInvscaledOutputF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest,
       DISABLED_TestConvScaledF8Parameterized) {
  MAYBE_SKIP_TEST("F8");
  TestF8Parameterized(
      // pre_hlo
      R"(
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestConvScaledBiasF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestConvScaledReluF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestConvScaledRelu6F8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestConvScaledEluF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestConvScaledLeakyReluF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestConvAmaxF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestConvReluAmaxF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest,
       DISABLED_TestConvScaledOutputMultipleUsersF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest,
       DISABLED_TestConvScaledOutputMultipleUsersInGraphAddF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest,
       DISABLED_TestConvScaledOutputMultipleUsersInGraphDoubleAddF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest,
       DISABLED_TestConvScaledOutputMultipleUsersInGraphTripleAddF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest,
       DISABLED_TestConvScaledOutputUnsupportedUserF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest,
       DISABLED_TestConvAddOperandReachableFromAmaxF8) {
  MAYBE_SKIP_TEST("F8");
  TestF8(
      // pre_hlo
      R"(
...
// TODO(b/485220832) Re-enable this test once e2e conv fusion pipeline is
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestConvInt8ToInt8) {
  MAYBE_SKIP_TEST("I8");
...
TEST_F(ConvFusionRewriterIntegrationTest, DISABLED_TestFusedConvInt8ToFloat) {
  MAYBE_SKIP_TEST("I8");
...
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest,
       DISABLED_TestFusedConvWithScaledInt8SideInputBiasInt8ToInt8) {
  MAYBE_SKIP_TEST("I8");
...
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest,
       DISABLED_TestFusedConvWithScaledFloatSideInputBiasInt8ToInt8) {
  MAYBE_SKIP_TEST("I8");
  // From:
...
// finalized.
TEST_F(ConvFusionRewriterIntegrationTest,
       DISABLED_TestFusedConvWithScaledInt8SideInputBiasInt8ToFloat) {
  MAYBE_SKIP_TEST("I8");
  // From:
  // clamp(max(0, alpha_conv * conv(x, w) + alpha_side *
