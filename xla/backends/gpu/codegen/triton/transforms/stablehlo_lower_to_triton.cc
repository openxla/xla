...
Value UnsignedIntegerToSignlessInteger(OpBuilder& builder, Value value) {
...
class LowerCompareOp : public mlir::OpRewritePattern<stablehlo::CompareOp> {
 ...
 private:
  ...
  Value GetCompareOp(mlir::PatternRewriter& rewriter,
    ...
    return arith::CmpFOp::create(rewriter, op.getLoc(),
                                 GetCmpFPredicate(direction).value(), lhs, rhs);
  }
};
 ...
 public:
  void runOnOperation() override {
    ...
    patterns.add<
        ...
        LowerReshape, LowerDotGeneral, LowerAllReduce, LowerCompareOp,
        LowerConvertOp,
