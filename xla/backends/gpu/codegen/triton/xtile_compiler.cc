...
absl::StatusOr<TritonWrapperResult> CompileTritonToLLVM(
  ...
  PassManagerWithLogging pm(&mlir_context, hlo_module, kernel_name,
                            "triton-to-llvm");
...
absl::Status LowerXTileToTriton(mlir::ModuleOp xtile_dialect_module,
                                ...
                                const se::DeviceDescription& device_info) {
  {
    ...
    PassManagerWithLogging pm(&mlir_context, hlo_module, fusion.name(),
                              "xtile-to-triton");
...

  {
    if (fusion.GetModule()
      ...
      PassManagerWithLogging pm(&mlir_context, *fusion.GetModule(),
                                fusion.name(),
    ...
    PassManagerWithLogging pm(&mlir_context, *fusion.GetModule(), fusion.name(),
                              "canonicalize-cse");
