...
absl::Status RocmTracer::InitProfiling(void* tool_data) {
  ...
  // roctx_range_annotations.cc's dual push. See DefaultProfilerDomain
  // there for why the XLA-side producer is opt-in and latched.
  //
  ...
  // collateral for an optional feature: MARKER_CORE_API may be absent in an
  // older rocprofiler-sdk, or already claimed by another tool in the process
