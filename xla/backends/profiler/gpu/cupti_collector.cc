...
size_t PmSamples::GetNumSamples() {
  return sampler_ranges_.size();
}

const std::vector<std::string>& PmSamples::GetMetrics() {
  return metrics_;
}

const std::vector<SamplerRange>& PmSamples::GetSamplerRanges() {
