...
TEST(HostTracerTest, ConsumeSucceedsWhileRecording) {
  ...
  auto* events_1 = std::any_cast<tsl::profiler::TraceMeRecorder::Events>(
      &(*data_vector_1)[0]);
  ...
  auto* events_2 = std::any_cast<tsl::profiler::TraceMeRecorder::Events>(
      &(*data_vector_2)[0]);
...
TEST(HostTracerTest, SerializeFailsWithNullSpace) {
  ...
  data_vector.push_back(tsl::profiler::TraceMeRecorder::Events());
...
TEST(HostTracerTest, SerializeFailsWithInvalidDataType) {
  auto tracer = CreateHostTracer({});
  tensorflow::profiler::XSpace space;
  std::any invalid_data = 42;  // Int instead of vector<any>
...
TEST(HostTracerTest, SerializeOkWithEmptyEvents) {
  ...
  data_vector.push_back(
      tsl::profiler::TraceMeRecorder::Events());  // Empty events
  data_vector.push_back(std::any());
...
TEST(HostTracerTest, ConsumeAndSerializeHappyPath) {
  ...
  auto* events =
      std::any_cast<tsl::profiler::TraceMeRecorder::Events>(&(*data_vector)[0]);
