...
// TODO(b/3432314d): Re-enable when EmbedFileSystem inherits from
// tsl::FileSystem. class EmbedFileSystemTest : public ::testing::Test {
//  protected:
//   \
//     static void SetUpTestCase() {
//       fs_ = new EmbedFileSystem();
//       QCHECK_OK(Env::Default()->RegisterFileSystem("embed", []() ->
//       FileSystem* {
//         return static_cast<FileSystem*>(fs_);
//       }));
//     }
//
...
//     result = absl::string_view();
//     EXPECT_THAT(
//         f->Read(contents.size(), result, absl::MakeSpan(scratch).subspan(0,
//         1)), StatusIs(absl::StatusCode::kOutOfRange));
