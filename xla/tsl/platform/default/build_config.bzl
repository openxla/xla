...
def tf_proto_library(
    ...
    """
    A backward-compatible (with old TF-custom protobuf and gGRPC rules) macro which wraps a bunch of
    standard rules to create protobuf and gRPC stubs, while preserving backward-compatible
