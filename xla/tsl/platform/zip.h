...
//
// Note on security: this function is not secure against maliciously crafted zip
// archives. Callers must ensure that the zip archive is from a trusted source.
