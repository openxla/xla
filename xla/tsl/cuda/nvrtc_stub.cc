...
void* GetDsoHandle() {
  ...
  static auto handle = []() -> void* {
    auto handle_or = tsl::internal::DsoLoader::GetNvrtcDsoHandle();
...
const char* kSymbols[] = {
#include "xla/tsl/cuda/nvrtc.inc"
};
...
static nvrtcResult GetSymbolNotFoundError() {
  return NVRTC_ERROR_INTERNAL_ERROR;
}

extern void* _nvrtc_tramp_table[];

void _nvrtc_tramp_resolve(int i) {
  CHECK_LE(0, i);
