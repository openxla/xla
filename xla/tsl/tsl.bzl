...
def if_nvshmem_tools(if_true, if_false = []):  # buildifier: disable=unused-variable
    ...
    return select({"@local_config_nvshmem//:nvshmem_tools": if_true, "//conditions:default": if_false})  # copybara:comment_replace return if_false
...
def if_nvshmem_libs(if_true, if_false = []):  # buildifier: disable=unused-variable
    ...
    return select({"@local_config_nvshmem//:nvshmem_tools_and_libs": if_true, "//conditions:default": if_false})  # copybara:comment_replace return if_false
