...
class PjRtCompilerRegistry {
 public:
  ...
  bool HasCompilerFor(absl::string_view platform_name,
                      absl::string_view variant_name)
...
// Thread-safe. Returns true if a compiler or a compiler factory is registered
// for the given platform and variant, i.e. if the variant can be served by
// this binary. Does not instantiate the compiler.
bool PjRtHasCompilerVariant(absl::string_view platform_name,
                            absl::string_view variant_name);
