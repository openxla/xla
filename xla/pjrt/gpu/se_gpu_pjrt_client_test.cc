...
TEST(StreamExecutorGpuClientTest, FailedCrossHostReceiveArgsSizeMismatch) {
  ...
  absl::StatusOr mismatch_status_or_1 = client->CrossHostReceiveBuffers(
  ...
  // transfer_keys.
  absl::StatusOr mismatch_status_or_2 = client->CrossHostReceiveBuffers(
      /*device=*/client->addressable_devices()[0],
      /*shapes=*/shapes,
      /*src_global_device_ids=*/{PjRtGlobalDeviceId(0)},
      /*transfer_key=*/{CrossHostTransferKey(0), CrossHostTransferKey(1)});
  EXPECT_THAT(
