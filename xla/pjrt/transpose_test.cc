...
TEST(TransposePlanCache, Basics) {
  ...
  std::vector<int64_t> odims = {1, 2, 3};
  o.dims = odims;
  std::vector<int64_t> operms = {2, 1, 0};
  o.permutation = operms;
  ...
  std::vector<int64_t> o2dims = {1, 2, 3};
  o2.dims = o2dims;
  std::vector<int64_t> o2perms = {1, 2, 0};
  o2.permutation = o2perms;
  ...
  std::vector<int64_t> o3dims = {1, 2, 3};
  o3.dims = o3dims;
  std::vector<int64_t> o3perms = {0, 1, 2};
  o3.permutation = o3perms;
