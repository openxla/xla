...
typedef struct PJRT_MultiSliceConfig PJRT_MultiSliceConfig;
...
struct PJRT_Megascale_CreateAoTConfig_Args {
  ...
  PJRT_MultiSliceConfig* multi_slice_config;  // out
};
...
struct PJRT_Megascale_DeleteMultiSliceConfig_Args {
  size_t struct_size;
  PJRT_MultiSliceConfig* multi_slice_config;
};
