...
static xla::PjRtCrossHostRecvNotifier CCrossHostRecvNotifierToCpp(
    const PJRT_CrossHostRecvNotifierInfo& c_notifier) {
...
PJRT_Error* PJRT_Client_MakeCrossHostReceiveBuffers(
  ...
  PJRT_RETURN_IF_ERROR(ActualStructSizeIsGreaterOrEqual(
      ...
      PJRT_Client_MakeCrossHostReceiveBuffers_Args_STRUCT_SIZE,
      args->struct_size));
...
PJRT_Api CreatePjrtApi(PJRT_Client_Create* create_fn,
  ...
  return PJRT_Api{
      ...
      pjrt::PJRT_Buffer_CopyToRemoteDevice,
      /*PJRT_Client_MakeCrossHostReceiveBuffers=*/
      pjrt::PJRT_Client_MakeCrossHostReceiveBuffers,
  };
}
