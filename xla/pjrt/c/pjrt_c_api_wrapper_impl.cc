...
PJRT_Error* PJRT_Executable_Serialize(PJRT_Executable_Serialize_Args* args) {
  ...
  const xla::PjRtExecutable& executable = *args->executable->get();
  std::string serialization;
  PJRT_ASSIGN_OR_RETURN(serialization, executable.SerializeExecutable());
...
PJRT_LoadedExecutable::PJRT_LoadedExecutable(
    ...
    : PJRT_Executable(std::move(executable)), client(client) {
