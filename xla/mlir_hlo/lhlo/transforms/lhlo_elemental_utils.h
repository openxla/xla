...
#ifndef XLA_MLIR_HLO_LHLO_TRANSFORMS_LHLO_ELEMENTAL_UTILS_H_
#define XLA_MLIR_HLO_LHLO_TRANSFORMS_LHLO_ELEMENTAL_UTILS_H_
...
#endif  // XLA_MLIR_HLO_LHLO_TRANSFORMS_LHLO_ELEMENTAL_UTILS_H_
