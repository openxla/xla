...
MLIR_CAPI_EXPORTED MlirAttribute mlirMhloSparsityDescriptorGet(
    MlirContext ctx, int64_t index, int64_t dimension, int64_t n, int64_t m);
...
// Returns the index, dimension and N:M sparsity configurations.
MLIR_CAPI_EXPORTED int64_t
mlirMhloSparsityDescriptorGetIndex(MlirAttribute attr);
MLIR_CAPI_EXPORTED int64_t
