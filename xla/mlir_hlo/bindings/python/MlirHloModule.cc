...
PYBIND11_MODULE(_mlirHlo, m) {
  ...
  mlir::python::adaptors::mlir_attribute_subclass(
      ...
      .def_classmethod(
          "get",
          [](py::object cls, const int64_t index, const int64_t dimension,
             const int64_t n, const int64_t m, MlirContext ctx) {
            return cls(
                mlirMhloSparsityDescriptorGet(ctx, index, dimension, n, m));
          },
          py::arg("cls"), py::arg("index"), py::arg("dimension"), py::arg("n"),
          py::arg("m"), py::arg("context") = py::none(),
          "Creates a SparseDescriptor attribute with the given sparsity "
          "configurations.")
      .def_property_readonly("index",
                             [](MlirAttribute self) {
                               return mlirMhloSparsityDescriptorGetIndex(self);
                             })
      .def_property_readonly(
          "dimension",
          [](MlirAttribute self) {
