// RUN: mlir-hlo-opt --stablehlo-compose-uniform-quantization --split-input-file --verify-diagnostics --debug %s | FileCheck %s
...
// CHECK-SAME: %[[ARG:.*]]: tensor<1x3x3x4xf32>
  func.func @quantized_conv_op(%arg0: tensor<1x3x3x4xf32>) -> tensor<1x3x3x4xf32> {
    %1 = stablehlo.constant dense<-128> : tensor<1x1x1x1xi8>  // Input zero point.
    %2 = stablehlo.constant dense<1.000000e+03> : tensor<1x1x1x1xf32>  // Input inverse scale.
    ...
    %5 = stablehlo.constant dense<127> : tensor<1x1x1x1xi8>  // Output zero point.
    %6 = stablehlo.constant dense<4.000000e+03> : tensor<1x1x1x1xf32>  // Output inverse scale.
    %7 = call @uniform_quantize_0(%arg0, %1, %2) : (tensor<1x3x3x4xf32>, tensor<1x1x1x1xi8>, tensor<1x1x1x1xf32>) -> tensor<1x3x3x4xi8>
    ...
    %11 = stablehlo.reshape %1 : (tensor<1x1x1x1xi8>) -> tensor<1xi8>
    ...
    %19 = call @uniform_quantize_1(%18, %5, %6) : (tensor<1x3x3x4xf32>, tensor<1x1x1x1xi8>, tensor<1x1x1x1xf32>) -> tensor<1x3x3x4xi8>
    %20 = call @uniform_dequantize_0(%19, %5, %6) : (tensor<1x3x3x4xi8>, tensor<1x1x1x1xi8>, tensor<1x1x1x1xf32>) -> tensor<1x3x3x4xf32>
...
// CHECK: return %[[DEQUANT]] : tensor<1x3x3x4xf32>
  ...
  func.func private @uniform_quantize_0(%arg0: tensor<1x3x3x4xf32>, %arg1: tensor<1x1x1x1xi8>, %arg2: tensor<1x1x1x1xf32>) -> tensor<1x3x3x4xi8> {
    %0 = stablehlo.convert %arg0 : (tensor<1x3x3x4xf32>) -> tensor<1x3x3x4xi8>
    return %0 : tensor<1x3x3x4xi8>
  }
// CHECK: @uniform_quantize_0
  func.func private @uniform_quantize_1(%arg0: tensor<1x3x3x4xf32>, %arg1: tensor<1x1x1x1xi8>, %arg2: tensor<1x1x1x1xf32>) -> tensor<1x3x3x4xi8> {
    %0 = stablehlo.convert %arg0 : (tensor<1x3x3x4xf32>) -> tensor<1x3x3x4xi8>
    return %0 : tensor<1x3x3x4xi8>
  }
// CHECK: @uniform_quantize_1
  func.func private @uniform_dequantize_0(%arg0: tensor<1x3x3x4xi8>, %arg1: tensor<1x1x1x1xi8>, %arg2: tensor<1x1x1x1xf32>) -> tensor<1x3x3x4xf32> {
...
// CHECK-SAME: %[[ARG:.*]]: tensor<1x3x3x4xf32>
  func.func @quantized_conv_op_with_no_filter_convert(%arg0: tensor<1x3x3x4xf32>) -> tensor<1x3x3x4xf32> {
    ...
    %10 = stablehlo.reshape %1 : (tensor<1x1x1x1xi8>) -> tensor<1xi8>
    ...
    %17 = call @uniform_quantize_1(%16, %5, %6) : (tensor<1x3x3x4xf32>, tensor<1x1x1x1xi8>, tensor<1x1x1x1xf32>) -> tensor<1x3x3x4xi8>
    %18 = call @uniform_dequantize_0(%17, %5, %6) : (tensor<1x3x3x4xi8>, tensor<1x1x1x1xi8>, tensor<1x1x1x1xf32>) -> tensor<1x3x3x4xf32>
