...
func.func @testDebatch2(%arg0: tensor<2x3xf32>, %arg1: tensor<1x1x2xf32>) -> tensor<3x1x1xf32> {
  // CHECK-DAG: [[R0:%.+]] = mhlo.transpose %arg0, dims = [1, 0] : (tensor<2x3xf32>) -> tensor<3x2xf32>
  // CHECK-DAG: [[R1:%.+]] = mhlo.transpose %arg1, dims = [2, 0, 1] : (tensor<1x1x2xf32>) -> tensor<2x1x1xf32>
...
func.func @testMatVec(%arg0: tensor<32x20xf32>, %arg1: tensor<32xf32>) -> tensor<20xf32> {
  // CHECK-NEXT: [[T:%.+]] = mhlo.transpose %arg0, dims = [1, 0]
...
// CHECK-DAG: %[[TRANS0:.+]] = mhlo.transpose %arg0, dims = [2, 3, 0, 1]
...
// CHECK-DAG: %[[TRANS1:.+]] = mhlo.transpose %arg1, dims = [2, 3, 0, 1]
