...
func.func @while_multi_operands(%arg0: tensor<3xi32>) -> tuple<tensor<i32>, tensor<3xi32>> {
  ...
  ^bb0(%arg1: tensor<i32> , %arg2: tensor<3xi32> ):
    ...
    // CHECK: %[[VAL_8:.*]] = mhlo.compare LT, %[[VAL_4]], %[[VAL_7]] : (tensor<i32>, tensor<i32>) -> tensor<i1>
  ...
  ^bb0(%arg1: tensor<i32>, %arg2: tensor<3xi32>):
    ...
    // CHECK: %[[VAL_16:.*]] = mhlo.broadcast_in_dim %[[VAL_15]], dims = [] : (tensor<i32>) -> tensor<3xi32>
  ...
  // CHECK: %[[VAL_18:.*]] = mhlo.tuple %[[VAL_19:.*]]#0, %[[VAL_19]]#1 {xla_shape = "(s32[], s32[3]{0})"} : tuple<tensor<i32>, tensor<3xi32>>
...
func.func @conditional(%arg0: tensor<f32>) -> tensor<f32> {
  ...
  // CHECK: %[[VAL_2:.*]] = mhlo.compare LT, %[[VAL_0]], %[[VAL_1]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
...
func.func @case2(%arg0 : tensor<i32>, %arg1 : tensor<4xf32>, %arg2 : tensor<4xf32>) -> tensor<4xf32> {
  ...
  // CHECK: %[[VAL_4:.*]] = mhlo.compare EQ, %[[VAL_0]], %[[VAL_3]], NOTYPE : (tensor<i32>, tensor<i32>) -> tensor<i1>
...
func.func @case3(%arg0 : tensor<i32>, %arg1 : tensor<4xf32>, %arg2 : tensor<4xf32>, %arg3 : tensor<4xf32>) -> tensor<4xf32> {
  ...
  // CHECK: %[[VAL_5:.*]] = mhlo.compare EQ, %[[VAL_0]], %[[VAL_4]], NOTYPE : (tensor<i32>, tensor<i32>) -> tensor<i1>
  ...
  // CHECK:   %[[VAL_10:.*]] = mhlo.compare EQ, %[[VAL_0]], %[[VAL_9]], NOTYPE : (tensor<i32>, tensor<i32>) -> tensor<i1>
