...
func.func @erf_f32(%arg : tensor<f32>) -> tensor<f32> {
  ...
  // CHECK-DAG: %[[TMP_2:.*]] = mhlo.clamp %[[TMP_0]], %[[ARG]], %[[TMP_1]]
  // CHECK-DAG: %[[TMP_3:.*]] = mhlo.multiply %[[TMP_2]], %[[TMP_2]]
  // CHECK-DAG: %[[TMP_4:.*]] = mhlo.constant dense<0.000000e+00>
  // CHECK-DAG: %[[TMP_5:.*]] = mhlo.multiply %[[TMP_4]], %[[TMP_3]]
  // CHECK-DAG: %[[TMP_6:.*]] = mhlo.constant dense<-2.72614237E-10>
  // CHECK-DAG: %[[TMP_7:.*]] = mhlo.add %[[TMP_5]], %[[TMP_6]]
  // CHECK-DAG: %[[TMP_8:.*]] = mhlo.multiply %[[TMP_7]], %[[TMP_3]]
  // CHECK-DAG: %[[TMP_9:.*]] = mhlo.constant dense<2.77068146E-8>
  // CHECK-DAG: %[[TMP_10:.*]] = mhlo.add %[[TMP_8]], %[[TMP_9]]
  // CHECK-DAG: %[[TMP_11:.*]] = mhlo.multiply %[[TMP_10]], %[[TMP_3]]
  // CHECK-DAG: %[[TMP_12:.*]] = mhlo.constant dense<-2.10102394E-6>
  // CHECK-DAG: %[[TMP_13:.*]] = mhlo.add %[[TMP_11]], %[[TMP_12]]
  // CHECK-DAG: %[[TMP_14:.*]] = mhlo.multiply %[[TMP_13]], %[[TMP_3]]
  // CHECK-DAG: %[[TMP_15:.*]] = mhlo.constant dense<-5.69250624E-5>
  // CHECK-DAG: %[[TMP_16:.*]] = mhlo.add %[[TMP_14]], %[[TMP_15]]
  // CHECK-DAG: %[[TMP_17:.*]] = mhlo.multiply %[[TMP_16]], %[[TMP_3]]
  // CHECK-DAG: %[[TMP_18:.*]] = mhlo.constant dense<-7.34990637E-4>
  // CHECK-DAG: %[[TMP_19:.*]] = mhlo.add %[[TMP_17]], %[[TMP_18]]
  // CHECK-DAG: %[[TMP_20:.*]] = mhlo.multiply %[[TMP_19]], %[[TMP_3]]
  // CHECK-DAG: %[[TMP_21:.*]] = mhlo.constant dense<-2.954600e-03>
  // CHECK-DAG: %[[TMP_22:.*]] = mhlo.add %[[TMP_20]], %[[TMP_21]]
  // CHECK-DAG: %[[TMP_23:.*]] = mhlo.multiply %[[TMP_22]], %[[TMP_3]]
  // CHECK-DAG: %[[TMP_24:.*]] = mhlo.constant dense<-0.0160960332>
  // CHECK-DAG: %[[TMP_25:.*]] = mhlo.add %[[TMP_23]], %[[TMP_24]]
  // CHECK-DAG: %[[TMP_26:.*]] = mhlo.constant dense<0.000000e+00>
  // CHECK-DAG: %[[TMP_27:.*]] = mhlo.multiply %[[TMP_26]], %[[TMP_3]]
  // CHECK-DAG: %[[TMP_28:.*]] = mhlo.constant dense<-1.45660715E-5>
  // CHECK-DAG: %[[TMP_29:.*]] = mhlo.add %[[TMP_27]], %[[TMP_28]]
  // CHECK-DAG: %[[TMP_30:.*]] = mhlo.multiply %[[TMP_29]], %[[TMP_3]]
  // CHECK-DAG: %[[TMP_31:.*]] = mhlo.constant dense<-2.13374049E-4>
  // CHECK-DAG: %[[TMP_32:.*]] = mhlo.add %[[TMP_30]], %[[TMP_31]]
  // CHECK-DAG: %[[TMP_33:.*]] = mhlo.multiply %[[TMP_32]], %[[TMP_3]]
  // CHECK-DAG: %[[TMP_34:.*]] = mhlo.constant dense<-0.00168282702>
  // CHECK-DAG: %[[TMP_35:.*]] = mhlo.add %[[TMP_33]], %[[TMP_34]]
  // CHECK-DAG: %[[TMP_36:.*]] = mhlo.multiply %[[TMP_35]], %[[TMP_3]]
  // CHECK-DAG: %[[TMP_37:.*]] = mhlo.constant dense<-0.00737332925>
  // CHECK-DAG: %[[TMP_38:.*]] = mhlo.add %[[TMP_36]], %[[TMP_37]]
  // CHECK-DAG: %[[TMP_39:.*]] = mhlo.multiply %[[TMP_38]], %[[TMP_3]]
  // CHECK-DAG: %[[TMP_40:.*]] = mhlo.constant dense<-0.0142647391>
  // CHECK-DAG: %[[TMP_41:.*]] = mhlo.add %[[TMP_39]], %[[TMP_40]]
  // CHECK-DAG: %[[TMP_42:.*]] = mhlo.multiply %[[TMP_2]], %[[TMP_25]]
  // CHECK-DAG: %[[TMP_43:.*]] = mhlo.constant dense<-1.000000e+00> : tensor<f32>
  // CHECK-DAG: %[[TMP_44:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
  // CHECK-DAG: %[[TMP_45:.*]] = mhlo.divide %[[TMP_42]], %[[TMP_41]]
  // CHECK-DAG: %[[RESULT:.*]] = mhlo.clamp %[[TMP_43]], %[[TMP_45]], %[[TMP_44]]
