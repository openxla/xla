...
bazel --bazelrc="$SCRIPT_DIR/rocm_xla_ci.bazelrc" test \
    ...
    --action_env=XLA_FLAGS="--xla_gpu_enable_llvm_module_compilation_parallelism=true --xla_gpu_force_compilation_parallelism=16 --xla_gpu_blas_max_algorithms=8 --xla_gpu_enable_triton_gemm=false" \
    --test_output=errors \
