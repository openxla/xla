...
load("@tsl//third_party/gpus:rocm_configure.bzl", "remote_rocm_configure")
load("@tsl//third_party/py:python_configure.bzl", "local_python_configure", "remote_python_configure")
load("@tsl//third_party/remote_config:remote_platform_configure.bzl", "remote_platform_configure")
