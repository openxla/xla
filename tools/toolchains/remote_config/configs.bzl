...
def initialize_rbe_configs():
    ...
    sigbuild_tf_configs(
        name_container_map = {
            "sigbuild-r2.14-clang17": "docker://gcr.io/tensorflow-sigs/build@sha256:4f2e7e3047cc4a859053a1da54c1a0c9857fdd14c6ceee37cc8d26628243ff05",
            "sigbuild-r2.14-clang17-python3.9": "docker://gcr.io/tensorflow-sigs/build@sha256:4f2e7e3047cc4a859053a1da54c1a0c9857fdd14c6ceee37cc8d26628243ff05",
            "sigbuild-r2.14-clang17-python3.10": "docker://gcr.io/tensorflow-sigs/build@sha256:6211b4317e197fe01b0144185260256019a72920316ed24906405584daf3f6e6",
            "sigbuild-r2.14-clang17-python3.11": "docker://gcr.io/tensorflow-sigs/build@sha256:3144e402bbbf61296433341cde68fd68a2e7c107f2c6dd966074d627c720e7de",
        },
        # Unclear why LIBC is set to 2.19 here, and yet manylinux2010 is 2.12
        # and manylinux2014 is 2.17.
        env = {
